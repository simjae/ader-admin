...
$material_td_kr = "NULL";
if (isset($_POST['material_td_kr']) && $_POST['material_td_kr'] != "") {
	$material_td_kr = "'".$_POST['material_td_kr']."'";
	$material_td_kr = str_replace("<p>&nbsp;</p>","",$material_td_kr);
}

$material_td_en = "NULL";
if (isset($_POST['material_td_en']) && $_POST['material_td_en'] != "") {
	$material_td_en = "'".$_POST['material_td_en']."'";
	$material_td_en = str_replace("<p>&nbsp;</p>","",$material_td_en);
}

$material_td_cn = "NULL";
if (isset($_POST['material_td_cn']) && $_POST['material_td_cn'] != "") {
	$material_td_cn = "'".$_POST['material_td_cn']."'";
	$material_td_cn = str_replace("<p>&nbsp;</p>","",$material_td_cn);
}
