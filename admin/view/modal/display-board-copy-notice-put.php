                ...
                <div class="content__row">
                    <div class="rd__block">
                        ...
                        <div class="content__date__picker">
                            <input class="display_date" type="date" name="display_from"  placeholder="From" readonly="" style="width:150px" onChange="" value="<?=$date_from_arr[0]?>" disabled>
                                
                            <select class="display_date" type="select" name="display_from_h" style="width:80px" value="" disabled>시 
                                <option value="" selected>시간</option>
                            </select>
                            <select class="display_date" type="select" name="display_from_m" style="width:80px" value="" disabled>분
                                <option value="" selected>분</option>
                            </select>
                            
                            <br><font class="" >~</font><br>
                            
                            <input class="display_date" type="date" name="display_to" placeholder="To" readonly="" style="width:150px; " onChange="" value="<?=$date_to_arr[0]?>" disabled>
                            <select class="display_date" type="select" name="display_to_h" style="width:80px" value="" disabled>시 
                                <option value="" selected>시간</option>
                            </select>
                            <select class="display_date" type="select" name="display_to_m" style="width:80px" value="" disabled>분
                                <option value="" selected>분</option>
                            </select>
                        </div>
                    </div>
			...
			success: function(d) {
				if(d.code == 200) {
					alert("공지사항 수정에 성공했습니다.",function(){
						location.href='/display/board/copy';
					});
				}
                else{
                    alert("공지사항 수정이 실패했습니다.");
