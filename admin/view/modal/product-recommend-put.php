		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="updatePageRecommend();"><span>추천상품 리스트 수정</span></div>
			...
			if(d.code == 200) {
				...
				data.forEach(function(row) {
					...
					product_info.forEach(function(product) {
						let strDiv = "";
						strDiv += '        <div id="' + product.product_code + '" class="product__img__wrap">';
						...
						strDiv += '                <div class="remove_product_btn" product_code="' + product.product_code + '" onClick="removeRecommendProduct(this);">삭제</div>';
						strDiv += '            </div>';
						strDiv += '        </div>';
...
function updatePageRecommend() {
	...
	$.ajax({
		...
		error: function() {
			alert('추천상품 리스트 수정 처리중 오류가 발생했습니다.');
		},
		success: function(d) {
			if(d.code == 200) {
				alert('추천상품 리스트가 정상적으로 수정되었습니다.',function(){
