				...
				<TBODY>
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="md_category">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="sale_flg">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="sold_out_flg">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="manufacturer">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="supplier">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="brand">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="origin_country">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="price">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="model">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="model_wear">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="product_keyword">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="product_tag">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
					...
					<TR>
						...
						<TD style="text-align:left;">
							<div class="cb__color form-group">
								<label>
									<input class="select_column" type="checkbox" value="memo">
									<span>검색항목 추가</span>
								</label>
							</div>
						</TD>
