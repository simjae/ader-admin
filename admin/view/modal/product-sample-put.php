...
<div class="content__card">
	<form id="frm-modal-list" action="pm/sample/list/get">
		...
		<div class="card__header">
            <div class="flex justify-between">
                <h3 id='bluemark_title'>샘플 목록 검색 결과</h3>
		...
		<div class="card__body">
			<div class="info__wrap " style="justify-content:space-between; align-items: center;">
				<div class="body__info--count">
					...
					총 샘플 목록 수 <font class="modal_cnt cnt_result info__count" >0</font>개
				</div>
...
function paramParsing(param_data){
	...
	$('input[name=sample_idx]').val(param_data.sample_idx);
