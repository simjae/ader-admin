		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfo_pop();"><span>검색</span></div>
...
function getOrderInfo_pop() {
	let td_length = $("#result_table_pop").children().length;
	if (td_length > 0) {
		$("#result_table_pop").html('');
		...
		$("#result_table_pop").append(strDiv);
	}
	
	var rows = $("#frm-list_POP").find('.rows').val();
	var page = $("#frm-list_POP").find('.page').val(1);
	
	get_contents($("#frm-list_POP"),{
		pageObj : $(".paging"),
		html : function(d) {
			$("#result_table_pop").html('');
