			...
			<div class="param_MN_EN">
				...
				<div class="content__wrap grid__half">
					...
					<div class="half__box__wrap">
						...
						<div class="content__row">
							<div class="rd__block">							
								<input id="menu_type_EN_PR" class="menu_type" type="radio" name="menu_type_EN" value="PR" country="EN" obj_type="MN" onClick="resetType(this);">
								<label for="menu_type_EN_PR">상품</label>
								
								<input id="menu_type_EN_PO" class="menu_type" type="radio" name="menu_type_EN" value="PO" country="EN" obj_type="MN" onClick="resetType(this);">
								<label for="menu_type_EN_PO">게시물</label>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="table table__wrap">
					<div class="table__filter">
						<div class="filrer__wrap">
							<div class="filter__btn" onclick="checkPageModal('EN','MN');">게시물 검색</div>
						</div>                          
					</div>
			...
			<div class="content__wrap content_menu_slide_EN" style="display:block;border:1px solid #bfbfbf;margin-top:15px;">
				...
				<div class="param_SL_EN" style="display:none;">
					...
					<div class="table table__wrap">
						<div class="table__filter">
							<div class="filrer__wrap">
								<div class="filter__btn" onclick="checkPageModal('EN','SL');">게시물 검색</div>
							</div>                          
						</div>
					...
					<div class="filter_param" style="display:flex;margin-top:15px;">
						...
						<div class="content__row">
							<div class="rd__block">							
								<input id="link_type_SL_EN_PR" class="link_type" type="radio" name="link_type_SL_EN" value="PR" country="EN" obj_type="SL" onClick="resetType(this);">
								<label for="link_type_SL_EN_PR">상품</label>
								
								<input id="link_type_SL_EN_PO" class="link_type" type="radio" name="link_type_SL_EN" value="PO" country="EN" obj_type="SL" onClick="resetType(this);">
					...
					<div class="filter_param" style="display:flex;margin-top:15px;">
						...
						<div class="add_menu_obj" onclick="checkMenuObjAction('EN','SL');">저장</div>
					</div>
			...
			<div class="content__wrap" style="display:block;border:1px solid #bfbfbf;margin-top:15px;">
				...
				<div class="param_UP_EN" style="display:none;">
					...
					<div class="table table__wrap">
						<div class="table__filter">
							<div class="filrer__wrap">
								<div class="filter__btn" onclick="checkPageModal('EN','UP');">게시물 검색</div>
							</div>                          
						</div>
					...
					<div class="filter_param" style="display:flex;margin-top:15px;">
						...
						<div class="content__row">
							<div class="rd__block">							
								<input id="link_type_UP_EN_PR" class="link_type" type="radio" name="link_type_UP_EN" value="PR" onClick="resetType('UP','EN')">
								<label for="link_type_UP_EN_PR">상품</label>
								
								<input id="link_type_UP_EN_PO" class="link_type" type="radio" name="link_type_UP_EN" value="PO" onClick="resetType('UP','EN')">
					...
					<div class="filter_param" style="display:flex;margin-top:15px;">
						...
						<div class="add_menu_obj" onclick="checkMenuObjAction('EN','UP');">저장</div>
					</div>
				</div>
			</div>
			...
			<div class="content__wrap" style="display:block;border:1px solid #bfbfbf;margin-top:15px;">
				...
				<div class="param_LW_EN" style="display:none;">
					...
					<div class="table table__wrap">
						<div class="table__filter">
							<div class="filrer__wrap">
								<div class="filter__btn" onclick="checkPageModal('EN','LW');">게시물 검색</div>
							</div>                          
						</div>
					...
					<div class="filter_param" style="display:flex;margin-top:15px;">
						...
						<div class="content__row">
							...
							<div class="add_menu_obj" onclick="checkMenuObjAction('EN','LW');">저장</div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="putMenu('EN');"><span>메뉴 수정</span></div>
