<div class="content__card">
	...
	<div class="card__body">
			...
			<div class="content__row">
				...
				<div class="content__date__wrap">
					...
					<div class="content__date__picker">
						<input id="admin_from" class="date_param" type="date" name="login_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="admin" onChange="dateParamChange(this);">
						<font>~</font>
						<input id="admin_to" class="date_param" type="date" name="login_to" placeholder="To" readonly style="width:150px;" date_type="admin" onChange="dateParamChange(this);">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="content__wrap">
			<div class="content__title">처리 상태</div>
			<div class="content__row">
				<div class="cb__color">
					<label>
		...
		<div class="card__body--hide detail_hidden" style="display: none;">
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="memberType7_1" class="radio__input" value="" name="memberType" />
							<label for="memberType7_1">전체</label>
							<input type="radio" id="memberType7_2" class="radio__input" value="" name="memberType" />
							<label for="memberType7_2">회원</label>
							...
							<input type="radio" id="memberType7_3" class="radio__input" value="" name="memberType" />
							<label for="memberType7_3">비회원</label>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="deliverType7_1" class="radio__input" value="" name="deliverType" />
							<label for="deliverType7_1">전체</label>
							<input type="radio" id="deliverType7_2" class="radio__input" value="" name="deliverType" />
							<label for="deliverType7_3">국내 배송</label>
							<input type="radio" id="deliverType7_3" class="radio__input" value="" name="deliverType" />
							<label for="deliverType7_3">해외 배송</label>
						</div>
					</div>
				</div>
				<div class="half__box__wrap" style="align-items:start;">
					...
					<div class="content__row">
						<div class="rd__block" style="flex-wrap: wrap;">
							<input type="radio" id="deliverInfo7_1" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo7_1">묶음 배송</label>
							<input type="radio" id="deliverInfo7_2" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo7_2">재 배송</label>
							<input type="radio" id="deliverInfo7_3" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo7_3">배송 메시지 입력</label>
							<input type="radio" id="deliverInfo7_4" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo7_4">부분 배송</label>
							<input type="radio" id="deliverInfo7_5" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo7_5">예약 주문</label>
							<input type="radio" id="deliverInfo7_6" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo7_6">정기 배송(결제)</label>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="paymentType7_1" class="radio__input" value="" name="paymentType" />
							<label for="paymentType7_1">전체</label>
							<input type="radio" id="paymentType7_2" class="radio__input" value="" name="paymentType" />
							<label for="paymentType7_2">수단 선택</label>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="paymentCompany7_1" class="radio__input" value="" name="paymentCompany" />
							<label for="paymentCompany7_1">전체</label>
							<input type="radio" id="paymentCompany7_2" class="radio__input" value="" name="paymentCompany" />
							<label for="paymentCompany7_2">업체 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="orderRoute7_1" class="radio__input" value="" name="orderRoute" />
							<label for="orderRoute7_1">전체</label>
							<input type="radio" id="orderRoute7_2" class="radio__input" value="" name="orderRoute" />
							<label for="orderRoute7_2">경로 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="inflowRoute7_1" class="radio__input" value="" name="inflowRoute" />
							<label for="inflowRoute7_1">전체</label>
							<input type="radio" id="inflowRoute7_2" class="radio__input" value="" name="inflowRoute" />
							<label for="inflowRoute7_2">경로 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
	...
	<div class="card__body">
		<div class="info__wrap justify-between">
			...
			<div class="content__row flex justify-end">
				...
				<select name="searchSorting" class="fSelect" style="wpidth:163px;float:right;margin-right:10px;">
