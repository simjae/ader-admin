			...
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row" style="display:block;">
					<div class="rd__block">
						...
						<input type="radio" id="order_status_OCC" class="radio__input" value="OCC" name="order_status">
						<label for="order_status_OCC">주문취소</label>
		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfoList('MNG_ALL');"><span>검색</span></div>
					<div class="defult__color__btn" onClick="init_fileter('frm-list_MNG_ALL', 'getOrderInfoList')"><span>초기화</span></div>
				</div>
			</div>
		</div> 
		<div class="hidden">
			<div class="excel__table__warp">
				<table id="excel_table_MNG_ALL">
					<thead id="excel_table_head_MNG_ALL">
					</thead>
					<tbody id="excel_result_table_MNG_ALL">
					</tbody>
				</table>
			</div>
		</div> 
			...
			<div class="table table__wrap tabNum tabNum_01">
				<div class="table__filter">
					<div class="filrer__wrap" style="width:420px;">
						<div style="width: 140px;" class="filter__btn" onclick="excelDownload('MNG_ALL', 'DF');">엑셀 다운로드(일반양식)</div>
						<div style="width: 140px;" class="filter__btn" onclick="excelDownload('MNG_ALL', 'SL');">엑셀 다운로드(매출정보)</div>
						<div style="width: 140px;" class="filter__btn" onclick="putOrderInfo('MNG_ALL')">환불완료처리</div>
					</div>
					<div style="width:50%;">
						<div class="btn" style="width:100px;text-align:center;float:right;" onClick="openSelectColumnModal('MNG_ALL');">설정</div>
					</div>
				</div>
				<div class="double__table__container">
					<div class="overflow-x-auto top__scroll">
						<table class="checkbox__table">
							...
							<tbody id="result_checkbox_table_MNG_ALL">
							</tbody>
						</table>
					</div>
					<div class="overflow-x-auto top__scroll">
						<TABLE id="result_table_MNG_ALL" style="min-width:100%;width:auto;"></TABLE>
					</div>
				</div>	
			</div>
