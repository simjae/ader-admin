			...
			<div class="content__row">
				...
				<div class="content__date__wrap">
					<div class="content__date__btn">
						<input id="search_date_return" type="hidden" name="search_date" value="" style="width:150px;">

						<div class="search_date_return date__picker" date_type="return" date="today" type="button" onclick="searchDateClick(this);">오늘</div>
						<div class="search_date_return date__picker" date_type="return" date="01d" type="button" onclick="searchDateClick(this);">어제</div>
						<div class="search_date_return date__picker" date_type="return" date="03d" type="button" onclick="searchDateClick(this);">3일</div>
						<div class="search_date_return date__picker" date_type="return" date="07d" type="button" onclick="searchDateClick(this);">7일</div>
						<div class="search_date_return date__picker" date_type="return" date="15d" type="button" onclick="searchDateClick(this);">15일</div>
						<div class="search_date_return date__picker" date_type="return" date="01m" type="button" onclick="searchDateClick(this);">1개월</div>
						<div class="search_date_return date__picker" date_type="return" date="03m" type="button" onclick="searchDateClick(this);">3개월</div>
					</div>
					<div class="content__date__picker">
						<input id="return_from" class="date_param" type="date" name="login_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="return" onChange="dateParamChange(this);">
						<font>~</font>
						<input id="return_to" class="date_param" type="date" name="login_to" placeholder="To" readonly style="width:150px;" date_type="return" onChange="dateParamChange(this);">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card__body--hide detail_hidden" style="display: none;">
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="memberType4_1" class="radio__input" value="" name="memberType" />
							<label for="memberType4_1">전체</label>
							<input type="radio" id="memberType4_2" class="radio__input" value="" name="memberType" />
							<label for="memberType4_2">회원</label>
							...
							<input type="radio" id="memberType4_3" class="radio__input" value="" name="memberType" />
							<label for="memberType4_3">비회원</label>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="deliverType4_1" class="radio__input" value="" name="deliverType" />
							<label for="deliverType4_1">전체</label>
							<input type="radio" id="deliverType4_2" class="radio__input" value="" name="deliverType" />
							<label for="deliverType4_2">국내 배송</label>
							<input type="radio" id="deliverType4_3" class="radio__input" value="" name="deliverType" />
							<label for="deliverType4_3">해외 배송</label>
						</div>
					</div>
				</div>
				<div class="half__box__wrap" style="align-items:start;">
					...
					<div class="content__row">
						<div class="rd__block" style="flex-wrap: wrap;">
							<input type="radio" id="deliverInfo4_1" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo4_1">묶음 배송</label>
							<input type="radio" id="deliverInfo4_2" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo4_2">재 배송</label>
							<input type="radio" id="deliverInfo4_3" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo4_3">배송 메시지 입력</label>
							<input type="radio" id="deliverInfo4_4" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo4_4">부분 배송</label>
							<input type="radio" id="deliverInfo4_5" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo4_5">예약 주문</label>
							<input type="radio" id="deliverInfo4_6" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo4_6">정기 배송(결제)</label>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="paymentType4_1" class="radio__input" value="" name="paymentType" />
							<label for="paymentType4_1">전체</label>
							<input type="radio" id="paymentType4_2" class="radio__input" value="" name="paymentType" />
							<label for="paymentType4_2">수단 선택</label>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="paymentCompany4_1" class="radio__input" value="" name="paymentCompany" />
							<label for="paymentCompany4_1">전체</label>
							<input type="radio" id="paymentCompany4_2" class="radio__input" value="" name="paymentCompany" />
							<label for="paymentCompany4_2">업체 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="orderRoute4_1" class="radio__input" value="" name="orderRoute" />
							<label for="orderRoute4_1">전체</label>
							<input type="radio" id="orderRoute4_2" class="radio__input" value="" name="orderRoute" />
							<label for="orderRoute4_2">경로 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="inflowRoute4_1" class="radio__input" value="" name="inflowRoute" />
							<label for="inflowRoute4_1">전체</label>
							<input type="radio" id="inflowRoute4_2" class="radio__input" value="" name="inflowRoute" />
							<label for="inflowRoute4_2">경로 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
