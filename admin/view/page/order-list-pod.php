		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfo_pod();"><span>검색</span></div>
...
function getOrderInfo_pod() {
	let td_length = $("#result_table_pod").children().length;
	if (td_length > 0) {
		$("#result_table_pod").html('');
		...
		$("#result_table_pod").append(strDiv);
	}

	var rows = $("#frm-list_POD").find('.rows').val();
	var page = $("#frm-list_POD").find('.page').val(1);
	
	get_contents($("#frm-list_POD"),{
		pageObj : $(".paging"),
		html : function(d) {
			$("#result_table_pod").html('');
