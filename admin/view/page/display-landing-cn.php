<div class="content__card">
	...
	<div class="card__body" style="display:flex;">
		<div class="landing__left__area" style="">
			<div class="main__banner__selector selector_CN selector_BNR_CN" onClick="toggleContainer('CN','BNR')">
				<div class="banner__selector__img"></div>
			</div>
			
			<div class="main__contents__selector selector_CN selector_CNT_CN" onClick="toggleContainer('CN','CNT')">
				<div class="contents__selector_img"></div>
			</div>
			
			<div class="main__images__selector selector_CN selector_IMG_CN" onClick="toggleContainer('CN','IMG')">
				<div class="images_selector_img"></div>
			</div>
		</div>
		
		<div class="landing__right__area">
			<div class="banner__info__container selected_container container_BNR_CN">
				...
				<form id="frm-put_BNR_CN" action="main/banner/put">
										...
										<td style="height:3vh;">
											<div class="contents__btn__wrap" style="display:flex;">
												<div class="rd__block">
													...
													<label for="banner_bg_color_BL_CN">BLACK</label>

													<input id="banner_bg_color_WH_CN" class="background_color bg_color_WH"  type="radio" name="background_color" value="WH">
													<label for="banner_bg_color_WH_CN">WHITE</label>
												</div>
											</div>
										</td>
									</tr>
										...
										<td>
											<div style="display:flex;">
												...
												<div class="rd__block" style="margin-left:20px;">
													<input id="BNR_btn1_display_flg_TRUE_CN" type="radio" name="btn1_display_flg" value="TRUE" checked>
													<label for="BNR_btn1_display_flg_TRUE_CN">표시</label>

													<input id="BNR_btn1_display_flg_FALSE_CN" type="radio" name="btn1_display_flg" value="FALSE">
													<label for="BNR_btn1_display_flg_FALSE_CN">비표시</label>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div style="display:flex;">
												...
												<div class="rd__block" style="margin-left:20px;">
													<input id="BNR_btn2_display_flg_TRUE_CN" type="radio" name="btn2_display_flg" value="TRUE" checked>
													<label for="BNR_btn2_display_flg_TRUE_CN">표시</label>

													<input id="BNR_btn2_display_flg_FALSE_CN" type="radio" name="btn2_display_flg" value="FALSE">
													<label for="BNR_btn2_display_flg_FALSE_CN">비표시</label>
												</div>
											</div>
										</td>
									</tr>
					...
					<div class="banner__data__btn__wrap">
						<div class="btn banner_update_btn" onClick="putMainBannerInfo('CN');">배너 정보 저장</div>
					</div>
				</form>
			</div>
			
			<div class="contents__info__container selected_container container_CNT_CN">
				<form id="frm-put_CNT_CN" action="main/contents/put">				
										...
										<td>
											<div class="contents__btn__wrap" style="display:flex;">
												<div class="rd__block">
													...
													<label for="contents_bg_color_BL_CN">BLACK</label>

													<input id="contents_bg_color_WH_CN" type="radio" name="background_color" value="WH">
													<label for="contents_bg_color_WH_CN">WHITE</label>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div style="display:flex;">
												...
												<div class="rd__block" style="margin-left:20px;">
													<input id="CNT_btn1_display_flg_TRUE_CN" type="radio" name="btn1_display_flg" value="TRUE" checked>
													<label for="CNT_btn1_display_flg_TRUE_CN">표시</label>

													<input id="CNT_btn1_display_flg_FALSE_CN" type="radio" name="btn1_display_flg" value="FALSE">
													<label for="CNT_btn1_display_flg_FALSE_CN">비표시</label>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td>
											<div style="display:flex;">
												...
												<div class="rd__block" style="margin-left:20px;">
													<input id="CNT_btn2_display_flg_TRUE_CN" type="radio" name="btn2_display_flg" value="TRUE" checked>
													<label for="CNT_btn2_display_flg_TRUE_CN">표시</label>

													<input id="CNT_btn2_display_flg_FALSE_CN" type="radio" name="btn2_display_flg" value="FALSE">
													<label for="CNT_btn2_display_flg_FALSE_CN">비표시</label>
												</div>
											</div>
										</td>
									</tr>
				...
				<div class="contents__data__btn__wrap">
					<div class="btn contents_update_btn" onClick="putMainContentsInfo('CN');">컨텐츠 정보 저장</div>
				</div>
			</div>
			
			<div class="images__info__container selected_container container_IMG_CN">
				<input class="recent_num" type="hidden" name="recent_num" value="0">
				<input class="recent_idx" type="hidden" name="recent_idx" value="0">
				...
				<form id="frm-put_IMG_CN" action="main/images/put">
									...
									<tr>
										...
										<td>
											<div style="display:flex;">
												...
												<div class="rd__block" style="margin-left:20px;">
													<input id="IMG_btn_display_flg_TRUE_CN" type="radio" name="btn_display_flg" value="TRUE" checked>
													<label for="IMG_btn_display_flg_TRUE_CN">표시</label>

													<input id="IMG_btn_display_flg_FALSE_CN" type="radio" name="btn_display_flg" value="FALSE">
													<label for="IMG_btn_display_flg_FALSE_CN">비표시</label>
												</div>
											</div>
										</td>
									</tr>
					...
					<div class="images__data__btn__wrap">
						<div class="btn images_update_btn" onClick="putMainImagesInfo('CN');">이미지 정보 저장</div>
					</div>
				</form>
			</div>
		</div>
...
$(document).ready(function() {
	getMainBannerInfoList('CN');
	getMainImagesInfoList('CN');
});
</script>