...
<div class="content__card">
		<div class="card__header">
            <h2>홈페이지 내 알림메세지 설정(영문몰)</h2>
			<div class="drive--x"></div>
		</div>
		<div class="card__body">
            <form id="frm-list-02">
                <input type="hidden" name="country" id="" value="EN">
                <div class="table__wrap table">
                    <table>
                        <tbody id="notice_table_02">
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input style="width:90%" placeholder="" type="text" name="alarm_message" id="">
                                    <p style="line-height:2; color: #888888;"> - This is a shopping mall screen message that is exposed when an unauthorized group clicks to view online survey results.</p>
                                </td>
                                <td style="width:85px"><button style="width:70px;height:30px;border:1px solid;background-color:black;color:#ffffff;font-size:0.5rem;cursor:pointer;" onclick="singleSaveBtn(this)">메세지 저장</button></td>
                            </tr>
                            <tr>
                    ...
                    <div class="flex justify-between" style="margin-top:20px;">  
                        <div class="black-btn" tab-num="02" onclick="saveAlarm(this)"><span>저장</span></div>
                    </div>
                </div>
            </form>
		</div>
