		...
		<div class="card__body">
			<div class="body__info--count" style="display: block;margin:20px 0;">
				...
				<div class="flex justify-between" style="gap:20px;">
					...
					<div>
						<button type="button" style="width:120px;height:30px;border:1px solid #000000;background-color:#ffffff;color:#000000;margin-right:10px;cursor:pointer;" onclick="location.href='/pm/ordersheet/regist/md'">오더시트 등록</button>
	...
	get_contents($("#frm-filter"),{
		...
		html : function(d) {
			...
			d.forEach(function(row) {
				...
				sampleBtn = `<button type="button" class="white_btn" onclick="location.href='/pm/sample/regist?ordersheet_idx=${row.ordersheet_idx}&product_code=${row.product_code}'">등록</button>`;
				...
				switch(row.sample_flg || row.wholesale_flg){
					case false:
						...
						break;
					case true:
						wholesaleBtn = `<button type="button" class="white_btn" onclick="location.href='/pm/wholesale/regist?ordersheet_idx=${row.ordersheet_idx}&product_code=${row.product_code}'">등록</button>`;
						break;
				...
				switch(row.wholesale_flg || row.factory_flg){
					case false:
						...
						break;
					case true:
						factoryBtn = `<button type="button" class="white_btn" onclick="location.href='/pm/factory/regist?ordersheet_idx=${row.ordersheet_idx}&product_code=${row.product_code}'">등록</button>`;
						break;
                ...
                strDiv = `
                        <tr> 
				            ...
				            <td style="cursor:pointer" onclick="location.href='/pm/ordersheet?ordersheet_idx=${row.ordersheet_idx}'">
...
function openOrdersheetUpdate(obj) {
	...
	var url = "/pm/ordersheet/update/" + authority + "?";
