<div class="filter-tap content__tap__01">
	<div class="wrap__bg--wh">
		<div class="file__wrap">
			...
			<div class="file__content__wrap" style="width:800px">
				<div style="margin: 20px 0;color: #8B929F;font-size: 12px;"><span class="content__exel__btn">상품등록용 엑셀 다운로드</span></div>	
				<p style="margin:10px 0;">상품 신규 등록시 전용 엑셀양식을 다운로드하여 정보 입력후 업로드 합니다.</p>
				<div>
                    ...
                    <button type="button"  class="exel__execute__btn" style="width:100px;height:30px;border:1px solid;background-color:#ffffff;cursor:pointer">상품 등록</button>
    ...
    <div class="hidden">
        <input class="upload_btn" id="upload_btn_01" name="upload_btn_01" type="file">
    </div>
</div>
