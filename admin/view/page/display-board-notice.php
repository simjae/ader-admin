...
<div class="content__card">
	<div class="card__header">
		<div class="flex justify-between">
			<h3>게시판 관리(공지사항)</h3>
			<div class="black-btn" onClick="location.href='/display/board/notice/regist'">추가하기</div>
		</div>
	</div>
	...
	<div class="card__footer">
		<div class="footer__btn__wrap" style="grid: none;">
			<div class="btn__wrap--lg">
				...
				<div class="defult__color__btn" onClick="init_filter('frm-list_03_01','getBoardTabInfo_03')"><span>초기화</span></div>
			</div>
		</div>
	</div> 
</div>
...
function getBoardTabInfo_03() {
	...
	$('#frm-list_03_'+subtab_num).find('.page').val(1);
