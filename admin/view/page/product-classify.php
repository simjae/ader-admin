...
<div class="main-wrap">
	<div class="product-tree">
		...
		<div class="tree__desciption">
			<form id="frm-list" action="product/get">
						...
						<table class="desciption__table">
							<tbody>
								<tr>
									...
									<th style="padding:10px 15px;background-color: #fff;">SHOP</th>
								</tr>
								<tr>
									<th style="background-color: #fff;width: 130px;text-align: center;">분류명</th>
									<td><input type="text" value="SHOP"></td>
								</tr>
								<tr>
			...
			<div class="content__card">
				<form id="frm-filter" action="">
					<div class="card__header">
						<h3 id="category_list">상품 목록 검색 결과</h3>
						<div class="drive--x"></div>
					</div>
					<div class="card__body">
...
<script>
var temp_save_node = new Array();
var temp_all_node = new Array();
$(document).ready(function() {
	$('#show').on('click', function() {
		$('#js--tree').jstree(true).show_node(obj);
	})
	...
	.on('changed.jstree', function (e, data) {
		...
		if(data && data.selected && data.selected.length) {
			...
			if(current_cate.length != 0){
				...
				$('#category_list').text("["+current_cate+"] 상품 목록 검색 결과");
...
function exCreate() {
	...
	var depth = $('#js--tree').jstree(true).get_node(sel).parents.length;
