			...
			<div class="content__row">
				...
				<div class="content__date__wrap">
					<div class="content__date__btn">
						<input id="search_date_deposit" type="hidden" name="search_date" value="" style="width:150px;">

						<div class="search_date_deposit date__picker" date_type="deposit" date="today" type="button" onclick="searchDateClick(this);">오늘</div>
						<div class="search_date_deposit date__picker" date_type="deposit" date="01d" type="button" onclick="searchDateClick(this);">어제</div>
						<div class="search_date_deposit date__picker" date_type="deposit" date="03d" type="button" onclick="searchDateClick(this);">3일</div>
						<div class="search_date_deposit date__picker" date_type="deposit" date="07d" type="button" onclick="searchDateClick(this);">7일</div>
						<div class="search_date_deposit date__picker" date_type="deposit" date="15d" type="button" onclick="searchDateClick(this);">15일</div>
						<div class="search_date_deposit date__picker" date_type="deposit" date="01m" type="button" onclick="searchDateClick(this);">1개월</div>
						<div class="search_date_deposit date__picker" date_type="deposit" date="03m" type="button" onclick="searchDateClick(this);">3개월</div>
					</div>
					<div class="content__date__picker">
						<input id="deposit_from" class="date_param" type="date" name="login_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="deposit" onChange="dateParamChange(this);">
						<font>~</font>
						<input id="deposit_to" class="date_param" type="date" name="login_to" placeholder="To" readonly style="width:150px;" date_type="deposit" onChange="dateParamChange(this);">
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card__body--hide detail_hidden" style="display: none;">
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="memberType1_1" class="radio__input" value="" name="memberType" />
							<label for="memberType1_1">전체</label>
							<input type="radio" id="memberType1_2" class="radio__input" value="" name="memberType" />
							<label for="memberType1_2">회원</label>
							...
							<input type="radio" id="memberType1_3" class="radio__input" value="" name="memberType" />
							<label for="memberType1_3">비회원</label>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="deliverType1_1" class="radio__input" value="" name="deliverType" />
							<label for="deliverType1_1">전체</label>
							<input type="radio" id="deliverType1_2" class="radio__input" value="" name="deliverType" />
							<label for="deliverType1_2">국내 배송</label>
							<input type="radio" id="deliverType1_3" class="radio__input" value="" name="deliverType" />
							<label for="deliverType1_3">해외 배송</label>
						</div>
					</div>
				</div>
				<div class="half__box__wrap" style="align-items:start;">
					...
					<div class="content__row">
						<div class="rd__block" style="flex-wrap: wrap;">
							<input type="radio" id="deliverInfo1_1" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo1_1">묶음 배송</label>
							<input type="radio" id="deliverInfo1_2" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo1_2">재 배송</label>
							<input type="radio" id="deliverInfo1_3" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo1_3">배송 메시지 입력</label>
							<input type="radio" id="deliverInfo1_4" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo1_4">부분 배송</label>
							<input type="radio" id="deliverInfo1_5" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo1_5">예약 주문</label>
							<input type="radio" id="deliverInfo1_6" class="radio__input" value="" name="deliverInfo" />
							<label for="deliverInfo1_6">정기 배송(결제)</label>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="paymentType1_1" class="radio__input" value="" name="paymentType" />
							<label for="paymentType1_1">전체</label>
							<input type="radio" id="paymentType1_2" class="radio__input" value="" name="paymentType" />
							<label for="paymentType1_2">수단 선택</label>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="paymentCompany1_1" class="radio__input" value="" name="paymentCompany" />
							<label for="paymentCompany1_1">전체</label>
							<input type="radio" id="paymentCompany1_2" class="radio__input" value="" name="paymentCompany" />
							<label for="paymentCompany1_2">업체 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="orderRoute1_1" class="radio__input" value="" name="orderRoute" />
							<label for="orderRoute1_1">전체</label>
							<input type="radio" id="orderRoute1_2" class="radio__input" value="" name="orderRoute" />
							<label for="orderRoute1_2">경로 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="inflowRoute1_1" class="radio__input" value="" name="inflowRoute" />
							<label for="inflowRoute1_1">전체</label>
							<input type="radio" id="inflowRoute1_2" class="radio__input" value="" name="inflowRoute" />
							<label for="inflowRoute1_2">경로 선택</label>
							<button style="width:80px;height:30px;border:1px solid;background-color:#ffffff;margin-left:15px;">설정</button>
						</div>
					</div>
				</div>
