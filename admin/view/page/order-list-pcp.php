		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfo_pcp();"><span>검색</span></div>
...
function getOrderInfo_pcp() {
	let td_length = $("#result_table_pcp").children().length;
	if (td_length > 0) {
		$("#result_table_pcp").html('');
		...
		$("#result_table_pcp").append(strDiv);
	}
	
	var rows = $("#frm-list_PCP").find('.rows').val();
	var page = $("#frm-list_PCP").find('.page').val(1);
	
	get_contents($("#frm-list_PCP"),{
		pageObj : $(".paging"),
		html : function(d) {
			$("#result_table_pcp").html('');
