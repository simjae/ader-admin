...
<div class="content__card">
	<form id="frm-filter" action="pcs/sample/list/get">
			...
			d.forEach(function(row) {
				...
				strDiv = `
					<tr > 
						...
						<td>${row.num}</td>
						<td><button type="button" class="white_btn" onclick="location.href='/pcs/sample/update?sample_idx=${row.sample_idx}&product_code=${row.product_code}'">편집</button></td>
...
function sampleAction(len){
	...
	$.ajax({
		...
		data: formData,
		dataType: "json",
		url: config.api + "pcs/sample/delete",
		error: function() {
