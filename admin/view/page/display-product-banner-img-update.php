<div class="content__card">
	...
	?>
	<form id="frm-put_IMG" action="display/product/banner/put">
		<input id="banner_type" name="banner_type" type="hidden" value="IMG">
			...
			if(d.code == 200) {
				...
				if (data != null) {
					data.forEach(function(banner_row) {
						...
						$('.img_div').css('background-image','url(\'' + banner_row.banner_location + '\')');
