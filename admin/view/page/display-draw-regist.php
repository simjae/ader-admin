                ...
                <div class="content__row">
                    <div class="content__date__wrap">
                        <div class="content__date__picker">
                            ...
                            <select id="announce_hour" class="time__select hour" date_type="hour" onChange="dateParamChange(this);" disabled></select>
                            <span>&nbsp;시</span>
                            <select id="announce_minite" class="time__select minite" date_type="minite" onChange="dateParamChange(this);" disabled></select>
							<span>&nbsp;분</span>
                        </div>
                    </div>
                </div>
    ...
    confirm('드로우를 추가하시겠습니까?', function () {
        ...
        $.ajax({
            ...
            success: function (d) {
                let code = d.code;
                if (code == 200) {
                    alert('드로우 등록이 완료되었습니다.',function(){
