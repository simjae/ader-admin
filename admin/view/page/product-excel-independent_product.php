...
<div class="card__body">
    <div class="hidden"><input class="upload_btn" id="upload_btn_04" name="upload_btn_04" type="file" style="visibility:hidden"></div>
    <div class="table table__wrap">
        <div class="overflow-x-auto">
            <table>
                ...
                <tbody>
                    <tr>
                        <td style="width: 20%;">개인결제 상품 등록용 엑셀 다운로드</td>
                        <td><div class="exel__btn"><a href="http://116.124.128.246:81/excel_form/개인결제상품 정보_엑셀등록용.xlsx" download>다운로드</a></div></td>
                    </tr>
                </tbody>
            </table>
        </div>
