		...
		<div class="card__body">
			<div class="info__wrap " style="justify-content:space-between; align-items: center;">
				<div class="body__info--count">
					...
					총 상품 수 <font class="cnt_WSH_total info__count" >0</font>개
				</div>
				
				<div class="content__row">
					<select style="width:163px;float:right;margin-right:10px;" onChange="orderChange_WSH(this);">
					...
					<select name="rows" style="width:163px;margin-right:10px;float:right;" onChange="rowsChange_WSH(this);">
			...
			<div class="padding__wrap">
				<input type="hidden" class="total_cnt" tab_status="WSH" value="0" onChange="setPaging_WSH(this);">
				<input type="hidden" class="result_cnt" tab_status="WSH" value="0" onChange="setPaging_WSH(this);">
            	<div class="paging_WSH"></div>
        	</div>
		</div>
	</div>
...
function getModalWhishInfo() {
	let frm = $('#frm-WSH');
	let result_body = $('#member_detail_WSH').find('.result_body');
...
function setPaging_WSH(obj) {
	var total_cnt = $(obj).parent().find('.total_cnt');
	var result_cnt = $(obj).parent().find('.result_cnt');
	
	$('.cnt_WSH_total').text(total_cnt.val());
}
