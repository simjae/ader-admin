<div class="content__card">
	<form id="frm-list_DPR" action="order/list/get">
		<input type="hidden" name="tab_status" value="DPR">
		...
		<input type="hidden" class="select_product_flg_DPR" name="select_product_flg" value="false">
		...
		<div class="card__body">
				...
				<div class="content__row">
					...
					<div class="content__date__wrap">
						<div class="content__date__btn">
							<input id="date_param_DPR" type="hidden" name="date_param" value="" style="width:150px;">

							<div class="search_date_DPR date__picker" date_type="DPR" date="today"	type="button" onclick="searchDateClick(this);">오늘</div>
							<div class="search_date_DPR date__picker" date_type="DPR" date="01d"	type="button" onclick="searchDateClick(this);">어제</div>
							<div class="search_date_DPR date__picker" date_type="DPR" date="03d"	type="button" onclick="searchDateClick(this);">3일</div>
							<div class="search_date_DPR date__picker" date_type="DPR" date="07d"	type="button" onclick="searchDateClick(this);">7일</div>
							<div class="search_date_DPR date__picker" date_type="DPR" date="15d"	type="button" onclick="searchDateClick(this);">15일</div>
							<div class="search_date_DPR date__picker" date_type="DPR" date="01m"	type="button" onclick="searchDateClick(this);">1개월</div>
							<div class="search_date_DPR date__picker" date_type="DPR" date="03m"	type="button" onclick="searchDateClick(this);">3개월</div>
							<div class="search_date_DPR date__picker" date_type="DPR" date="01y"	type="button" onclick="searchDateClick(this);">1년</div>
						</div>
						
						<div class="content__date__picker">
							<input id="date_from_DPR" class="date_param_DPR" type="date" name="date_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="DPR" onChange="dateParamChange(this);">
								<font>~</font>
							<input id="date_to_DPR" class="date_param_DPR" type="date" name="date_to" placeholder="To" readonly style="width:150px;" date_type="DPR" onChange="dateParamChange(this);">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="content__wrap grid__half">
				...
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="delivery_type_ALL_DPR" class="radio__input" value="ALL" name="delivery_type" checked>
							<label for="delivery_type_ALL_DPR">전체</label>
							
							<input type="radio" id="delivery_type_KR_DPR" class="radio__input" value="KR" name="delivery_type">
							<label for="delivery_type_KR_DPR">국내 배송</label>
							
							<input type="radio" id="delivery_type_FR_DPR" class="radio__input" value="FR" name="delivery_type">
							<label for="delivery_type_FR_DPR">해외 배송</label>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfoList('DPR');"><span>검색</span></div>
					<div class="defult__color__btn" onClick="init_fileter('frm-list_DPR', 'getOrderInfoList')"><span>초기화</span></div>
				</div>
			</div>
		</div> 
		<div class="hidden">
			<div class="excel__table__warp">
				<table id="excel_table_DPR">
					<thead id="excel_table_head_DPR">
					</thead>
					<tbody id="excel_result_table_DPR">
					</tbody>
				</table>
			</div>
		</div> 
			...
			<div class="table table__wrap tabNum tabNum_01">	
				<div class="table__filter">
					<div class="filrer__wrap" style="width:280px;">
						<div style="width: 140px;" class="filter__btn" onclick="excelDownload('DPR', 'DF');">엑셀 다운로드(일반양식)</div>
						<div style="width: 140px;" class="filter__btn" onclick="excelDownload('DPR', 'SL');">엑셀 다운로드(매출정보)</div>
					</div>
					<div style="width:50%;">
						<div class="btn" style="width:100px;text-align:center;float:right;" onClick="openSelectColumnModal('DPR');">설정</div>
					</div>
				</div>
				<div class="double__table__container">
					<div class="overflow-x-auto top__scroll">
						<table class="checkbox__table">
							...
							<tbody id="result_checkbox_table_DPR">
							</tbody>
						</table>
					</div>
					<div class="overflow-x-auto top__scroll">
						<TABLE id="result_table_DPR" style="min-width:100%;width:auto;">
