		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfo_dpr();"><span>검색</span></div>
...
function getOrderInfo_dpr() {
	let td_length = $("#result_table_dpr").children().length;
	if (td_length > 0) {
		$("#result_table_dpr").html('');
		...
		$("#result_table_dpr").append(strDiv);
	}
	
	var rows = $("#frm-list_DPR").find('.rows').val();
	var page = $("#frm-list_DPR").find('.page').val(1);
	
	get_contents($("#frm-list_DPR"),{
		pageObj : $(".paging"),
		html : function(d) {
			$("#result_table_dpr").html('');
