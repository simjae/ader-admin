			...
			d.forEach(function(row) {
				...
				strDiv = `
					<tr > 
						...
						<td>${row.num}</td>
						<td><button type="button" class="white_btn" onclick="location.href='/product/wholesale/update?wholesale_idx=${row.wholesale_idx}&product_code=${row.product_code}'">편집</button></td>
