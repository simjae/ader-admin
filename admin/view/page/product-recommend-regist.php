...
<div class="content__card modal__view" style="margin: 0;">
	...
	<div class="card__body" style="overflow-y:scroll">
			...
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="table table__wrap">
						<TABLE style="width:80%;" class="table_add">
							<THEAD>
								<TR>
									<TH style="width:3%;">
										<label>
											<input type="checkbox" table_type="add" onClick="selectAllClick(this);">
											<span></span>
										</label>
									</TH>
									<TH>추천옵션 타이틀</TH>
...
function addPageRecommend() {
	...
	$.ajax({
		...
		error: function() {
			alert('추천상품 리스트 조회처리중 오류가 발생했습니다.');
		},
		success: function(d) {
			if(d.code == 200) {
				alert(
