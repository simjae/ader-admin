...
<div class="content__card">
    <div class="url__wrap">
        <div>이름 :<span>project #14</span></div>
        <div>적용몰 :<span>한국몰</span></div>
        <div>URL :<span>https://www.adererror.com/collection/index.html?cate_no=78</span></div>
    ...
    <div class="page__wrap">
        <div class="edit__wrap">
            <div class="edit__title__wrap">
                <div>
                    <h3 class="edit__title">collection Page</h3>
                </div>
...
<script>
        ...
        addslide.addEventListener('click', () => {
            thumbSwiper.appendSlide(`
                <div class="swiper-slide">
                    <img src="/images/display/collection/sample${imgName}.jpeg" alt="">
                </div>
            `)
    ...
    function imgDataCall(){
        ...
        for (let imgNum = 0; imgNum < length; imgNum++) {
            htmlArr.push(`
                <div class="swiper-slide">
                    <img src="/images/display/collection/sample${imgNum}.jpeg" alt="">
                </div>
            `);
        }
