	...
	<div class="card__body">
		...
		<div class="table table__wrap">
			<div class="overflow-x-auto">
				<table>
					...
					<tbody>
						<tr>
							<td style="width: 20%;">부자재 일괄등록용 엑셀 다운로드</td>
							<td><div class="exel__btn"><a href="http://116.124.128.246:81/excel_form/부자재 정보_엑셀등록용.xlsx" download>다운로드</a></div></td>
						</tr>
					</tbody>
				</table>
			</div>
		...
		<div class="table table__wrap">
			...
			<div class="exel__btn__wrap">
				<div class="exel__btn blue exel__execute__btn">부자재 등록</div>
