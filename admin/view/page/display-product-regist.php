	...
	<form id="frm-add">
		...
		<div class="card__body">			
			...
			<div class="content__wrap">
                ...
                <div class="content__row">
					<div id="display_member_wrap" class="cb__color sub hidden" style="width:100%;overflow-x:auto;">
						<?php
							$sql = "
									SELECT
										LV.IDX		AS LEVEL_IDX,
		...
		<div class="card__footer">
			<div class="footer__btn__wrap" style="grid: none;">
				<div class="btn__wrap--lg">
					<div  onclick="addPageProduct();" class="blue__color__btn"><span>저장</span></div>
...
function addPageProduct(){
	...
	confirm('상품 진열 페이지를 등록하시겠습니까?',function() {
		$.ajax({
			type: "post",
			data: formData,
			dataType: "json",
			url: config.api + "display/product/add",
			error: function() {
				alert("상품 진열 페이지 등록 처리 중 오류가 발생했습니다.");
			},
			success: function(d) {
				if(d.code == 200) {
					confirm(
						'상품 진열  페이지가 등록되었습니다.',
						function () {
							insertLog("전시관리 > 상품 진열 페이지", "상품 진열 페이지 등록", 1);
