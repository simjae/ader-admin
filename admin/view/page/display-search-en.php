						...
						<TBODY>
							<TR>
								...
								<TD style="text-align:center;">
									<div class="search_posting_btn" onClick="getKeywordModal('EN');">검색</div>
								</TD>
								<TD>
	...
	<div class="card__body">
		<form id="frm-PRD_EN">
			<div class="table table__wrap">
				<div class="table__filter">
					<div class="filrer__wrap">
						<div style="width: 140px;" class="filter__btn" onClick="deleteProduct('EN');">삭제</div>
...
$(document).ready(function() {
	getRecommendKeyword('EN');
	getPopularProduct('EN');
});
</script>