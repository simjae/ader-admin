<div class="content__card">
	...
	<div class="flex" style="gap:50px;margin:20px 0;">
		...
		<input id="exhibition_country" type="hidden" value="all">
	</div>
	
	<div class="card__body">
		<div id="exhibition_country_all" class="exhibition_country_tab">
			<form id="frm-04-all-list" action="display/posting/get">
				...
				<div class="info__wrap " style="justify-content:space-between; align-items: center;">
					<div class="body__info--count">
						...
						총 <font id="cnt_04_all_total" class="info__count">0</font>개 
					</div>
		...
		<div id="exhibition_country_KR" class="exhibition_country_tab" style="display:none;">
			<form id="frm-04-KR-list" action="display/posting/get">
				<input type="hidden" class="tab_num" name="tab_num" value="04">
				...
				<div class="info__wrap " style="justify-content:space-between; align-items: center;">
					<div class="body__info--count">
						<div class="drive--left"></div>
						총 <font id="cnt_04_KR_total" class="info__count">0</font>개 
					</div>
		...
		<div id="exhibition_country_EN" class="exhibition_country_tab" style="display:none;">
			<form id="frm-04-EN-list" action="display/posting/get">
				<input type="hidden" class="tab_num" name="tab_num" value="04">
				...
				<div class="info__wrap " style="justify-content:space-between; align-items: center;">
					<div class="body__info--count">
						<div class="drive--left"></div>
						총 <font id="cnt_04_EN_total" class="info__count">0</font>개 
					</div>
		...
		<div id="exhibition_country_CN" class="exhibition_country_tab" style="display:none;">
			<form id="frm-04-CN-list" action="display/posting/get">
				<input type="hidden" class="tab_num" name="tab_num" value="04">
				...
				<div class="info__wrap " style="justify-content:space-between; align-items: center;">
					<div class="body__info--count">
						<div class="drive--left"></div>
						총 <font id="cnt_04_CN_total" class="info__count">0</font>개 
					</div>
...
function exhibitionCountryTabClick(obj) {
	...
	$('#exhibition_country').val(country);
	
	if (country != null) {
		$('.exhibition_country_tab').hide();
		$('#exhibition_country_' + country).show();
	}
...
function getPostingExhibitionInfo() {
	var country = $('#exhibition_country').val();
	
	var result_table = $("#result_04_" + country + "_table").html('');
	
	var form = $('#frm-04-' + country + '-list');
