				...
				<div class="table table__wrap">
					...
					<div class="overflow-x-auto" id="insert_table_DSN">
							...
							<TBODY>
								...
								<TR>
									...
									<TD colspan="6">
										<div class="cb__color">
											<label>
												<input class="size_name mobile_iphone" type="checkbox" name="size_name" value="F">
												<span>iPhone Mini</span>
											</label>
											<label>
												<input class="size_name mobile_iphone" type="checkbox" name="size_name" value="F">
								...
								<TR>
									...
									<TD colspan="6">
										<div class="cb__color">
											<label>
												<input class="size_name mobile_galaxy" type="checkbox" name="size_name" value="F">
												<span>Galaxy S23</span>
											</label>
											<label>
												<input class="size_name mobile_galaxy" type="checkbox" name="size_name" value="F">
								...
								<TR>
									...
									<TD colspan="6">
										<div class="cb__color">
											<label>
												<input class="size_name airpods" type="checkbox" name="size_name" value="F">
												<span>AirPods 2세대</span>
											</label>
											<label>
												<input class="size_name airpods" type="checkbox" name="size_name" value="F">
								...
								<TR>
									...
									<TD colspan="6">
										<div class="cb__color">
											<label>
												<input class="size_name laptop" type="checkbox" name="size_name" value="F">
											<span>Macbook AIR M1</span>
											</label>
											<label>
												<input class="size_name laptop" type="checkbox" name="size_name" value="F">
								...
								<TR>
									...
									<TD colspan="6">
										<div class="cb__color">
											<label>
												<input class="size_name watch" type="checkbox" name="size_name" value="F">
												<span>Apple Watch 38/40/41</span>
											</label>
											<label>
												<input class="size_name watch" type="checkbox" name="size_name" value="F">
						...
						<TABLE>
							...
							<TBODY>
								<TR>
									<TH style="width:10%;"><p class="required_title">* 제품 상세정보 (한글)</p></TH>
									<TD>
								...
								<TR>
									<TH style="width:10%;"><p class="required_title">* 제품 상세정보 (영문)</p></TH>
									<TD>
								...
								<TR>
									<TH style="width:10%;"><p class="required_title">* 제품 상세정보 (중문)</p></TH>
									<TD>
						...
						<TABLE>
							...
							<TBODY>
								<TR>
									<TH style="width:10%;"><p class="required_title">* 제품 취급 유의사항<br>디자인 (한글)</p></TH>
									<TD>
								...
								<TR>
									<TH style="width:10%;"><p class="required_title">* 제품 취급 유의사항<br>디자인 (영문)</p></TH>
									<TD>
								...
								<TR>
									<TH style="width:10%;"><p class="required_title">* 제품 취급 유의사항<br>디자인 (중문)</p></TH>
									<TD>
						...
						<TABLE>
							...
							<TBODY>
								<TR>
									<TH style="width:10%;"><p class="required_title">* 디자인-소재(한글)</p></TH>
									<TD>
										<textarea class="width-100p" id="material_dsn_kr" name="material_dsn_kr"
											style="width:90%; height:150px;"></textarea>
									</TD>
								</TR>

								<TR>
									<TH style="width:10%;"><p class="required_title">* 디자인-소재 (영문)</p></TH>
									<TD>
										<textarea class="width-100p" id="material_dsn_en" name="material_dsn_en"
											style="width:90%; height:150px;"></textarea>
									</TD>
								</TR>

								<TR>
									<TH style="width:10%;"><p class="required_title">* 디자인-소재 (중문)</p></TH>
									<TD>
										<textarea class="width-100p" id="material_dsn_cn" name="material_dsn_cn"
											style="width:90%; height:150px;"></textarea>
									</TD>
								</TR>
							</TBODY>
...
function putOrdersheetInfo_DSN(flg) {
	...
	$.ajax({
		...
		data: formData,
		dataType: "json",
		url: config.api + "pcs/ordersheet_copy/dsn/put",
		cache: false,
		contentType: false,
		processData: false,
		error: function () {
