            ...
            <div class="content__wrap">
                ...
                <div class="content__row">
                    <div class="rd__block">
                        ...
                        <label for="member_level_EN_all">전체</label>
<?php
	...
	<div class="card__footer">
		<div class="footer__btn__wrap">
			...
			<div class="btn__wrap--lg">
				<div class="blue__color__btn" onClick="getPreorderList('EN');"><span>검색</span></div>
				<div class="defult__color__btn" onClick="init_fileter('frm-preorder-filter_EN','getPreorderList','EN')"><span>초기화</span></div>
			</div>
		</div>
	</div>
</div>
			...
			<div class="table table__wrap">
				...
				<div class="double__table__container">
					<table class="preorder__checkbox__table">
							...
							<tr class="checkbox_tr_EN">
								<th class="check__box__area">
									<div class="td__wrap">
										<div class="cb__color">
											<label>
												<input type="checkbox" class="select" name="preorder_idx[]" value="" onclick="selectAllClick(this,'EN')">
												<span></span>
											</label>
										</div>
									</div>
						...
						<tbody id="preorder_checkbox_table_EN">
						</tbody>
					</table>
