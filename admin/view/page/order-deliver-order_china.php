	...
	<div class="content__card">
		...
		<div class="card__body">
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row" style="display: block;">
					<div class="rd__block" style="margin-bottom: 10px;">
						<input type="radio" id="autoAppl3_1" class="radio__input" value="" name="autoAppl" checked="checked"/>
						<label for="autoAppl3_1">사용함</label>
						<input type="radio" id="autoAppl3_2" class="radio__input" value="" name="autoAppl"/>
						<label for="autoAppl3_2">사용안함</label>
					</div>
					<div class="cb__color">
						<label>
			...
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row" style="display: block;">
					<div class="rd__block" style="margin-bottom:10px;">
						<input type="radio" id="autoCheck3_1" class="radio__input" value="" name="autoCheck" checked="checked"/>
						<label for="autoCheck3_1">사용함</label>
						<input type="radio" id="autoCheck3_2" class="radio__input" value="" name="autoCheck"/>
						<label for="autoCheck3_2">사용안함</label>
					</div>
					<div>
	...
	<div class="content__card">
		...
		<div class="card__body">
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row" style="display: block;">
					<div class="rd__block" style="margin-bottom: 10px;">
						<input type="radio" id="refundFlg3_1" class="radio__input" value="" name="refundFlg"/>
						<label for="refundFlg3_1">사용함</label>
						<input type="radio" id="refundFlg3_2" class="radio__input" value="" name="refundFlg"/>
						<label for="refundFlg3_2">사용 안함</label>
					</div>
				</div>
			</div>
			<div class="content__wrap" style="align-items: start;">
			...
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="rd__block">
						<input type="radio" id="productReady3_1" class="radio__input" value="" name="productReady"/>
						<label for="productReady3_1">사용함</label>
						<input type="radio" id="productReady3_2" class="radio__input" value="" name="productReady"/>
						<label for="productReady3_2">사용안함</label>
					</div>
				</div>
			</div>
			<div class="content__wrap" style="align-items: start;">
			...
			<div class="content__wrap" style="align-items: self-start;">
				...
				<div class="content__row" style="display: block;">
					<div class="rd__block"style="display: block;">
						<input type="radio" id="autoCancel3_1" class="radio__input" value="" name="autoCancel"/>
						<label for="autoCancel3_1">사용함</label>
						<div style="margin: 10px 15px;display: grid;row-gap: 10px;">
							<div class="autoCancel__wrap3">
								<span>* 무통장입금 :</span>
					...
					<div class="rd__block">
						<input type="radio" id="autoCancel3_2" class="radio__input" value="" name="autoCancel"/>
						<label for="autoCancel3_2">사용안함</label>
					</div>
				</div>
			</div>
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row">
					<div class="rd__block" style="flex-direction: column;">
						<input type="radio" id="adminMemo3_1" class="radio__input" value="" name="adminMemo"/>
						<label for="adminMemo3_1">취소/반품/교환/환불 사유 입력시 관리자 메모에 연동함</label>
						<input type="radio" id="adminMemo3_2" class="radio__input" value="" name="adminMemo"/>
						<label for="adminMemo3_2">취소/반품/교환/환불 사유 입력시 관리자 메모에 연동안함</label>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="content__card">
		...
		<div class="card__body">
			...
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="rd__block">
						<input id="deliverCostPerEachFlg3_1" type="radio" name="deliverCostPerEachFlg" value="" checked>
						<label for="deliverCostPerEachFlg3_1">사용함</label>
						
						<input id="deliverCostPerEachFlg3_2" type="radio" name="deliverCostPerEachFlg" value="">
						<label for="deliverCostPerEachFlg3_2">사용안함</label>
					</div>
				</div>
			</div>
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="rd__block">
						<input id="deliverCostCalcFlg3_1" type="radio" name="deliverCostCalcFlg" value="" checked>
						<label for="deliverCostCalcFlg3_1">상품별로 배송비 계산</label>
						
						<input id="deliverCostCalcFlg3_2" type="radio" name="deliverCostCalcFlg" value="">
						<label for="deliverCostCalcFlg3_2">품목별로 배송비 계산</label>
					</div>
				</div>
			</div>
			<div class="body__info--count">
