				...
				<div class="content__row">
					...
					<div class="content__date__wrap">
						<div class="content__date__btn">
							...
							<div class="search_date_stock_regist date__picker" date_type="stock_regist" date="all" type="button" onclick="searchDateClick(this);">전체</div>
							...
							<div class="search_date_stock_regist date__picker" date_type="stock_regist" date="01y" type="button" onclick="searchDateClick(this);">1년</div>
						</div>
						<div class="content__date__picker">
							<input id="stock_regist_from" class="date_param" type="date" name="date_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="stock_regist" onChange="dateParamChange(this);">
							<font>~</font>
							<input id="stock_regist_to" class="date_param" type="date" name="date_to" placeholder="To" readonly style="width:150px;" date_type="stock_regist" onChange="dateParamChange(this);">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card__body--hide detail_hidden" style="display: none;">
					...
					<div class="half__box__wrap">
						...
						<div class="content__row">
							<div class="rd__block">
								...
								<label for="regist_sold_out_status_false">품절</label>
								
								<input id="regist_sold_out_status_true" type="radio" name="sold_out_status" value="true">
								<label for="regist_sold_out_status_true">품절 아님</label>
							</div>
						</div>
					</div>
				</div>
				<div class="content__wrap grid__half">
					...
					<div class="half__box__wrap">
						...
						<div class="content__row">
							<div class="rd__block">
								<input id="regist_sale_flg_all" type="radio" name="sale_flg" value="all" checked>
								<label for="regist_sale_flg_all">전체</label>
								
								<input id="regist_sale_flg_true" type="radio" name="sale_flg" value="true">
								<label for="regist_sale_flg_true">판매 함</label>
								
								<input id="regist_sale_flg_false" type="radio" name="sale_flg" value="false">
								<label for="regist_sale_flg_false">판매 안함</label>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					...
					<div class="defult__color__btn" onClick="init_filter('frm-list_01', 'getProductStockList')"><span>초기화</span></div>
				</div>
			</div>
		</div> 
	</form>
		...
		html : function(d) {
			if(d != null){
				...
				d.forEach(function(row) {
					...
					if (stock_status == "적용대기") {
						update_color = "#140f82";
						delete_color = "#e7505a";
						btn_disabled = "";
						number_readonly = "";
					} else if (stock_status == "적용완료") {
						update_color = "#bfbfbf";
						delete_color = "#bfbfbf";
		...
		success: function(d) {
			...
			if (data != null) {
				...
				data.forEach(function(row) {
					strDiv += '<TR>';
					strDiv += '    <TD>';
					strDiv += '        <font barcode="' + row.barcode + '">' + row.barcode + '</font>';
					strDiv += '    </TD>';
					strDiv += '    <TD>' + row.option_name + '</TD>';
