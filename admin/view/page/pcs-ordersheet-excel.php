...
<div class="filter-wrap" style="margin-bottom:20px">
	<button class="excel_tab_btn tap__button" tab_num="01" style="background-color: #000;color: #fff;font-weight: 500;" onClick="excelTabBtnClick(this);">엑셀-오더시트 등록</button>
</div>
...
<div id="excel_tab_01" class=" excel_tab">
	<?php include_once("pcs-ordersheet-excel-ordersheet_regist.php"); ?>
</div>
...
function readExcel(element){
    ...
    reader.onload = function () {
        ...
        workBook.SheetNames.forEach(function (sheetName) {
            if(sheetName == '오더시트 등록정보'){
                var ordersheet_regist_sheet = XLSX.utils.sheet_to_json(workBook.Sheets[sheetName], {range : 3, header:1});
                total_row.ordersheet_regist_sheet = ordersheet_regist_sheet;
            }
        })
		...
		switch(num){
			case '01':
				sheet = 'ordersheet_regist_sheet';
				err_msg = '오더시트 등록정보 시트가 존재하지 않습니다.';
				break;
		}
