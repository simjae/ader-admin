<div class="content__card">
	<form id="frm-list_ORD_ALL" action="order/list/get">
		...
		<input type="hidden" class="select_product_flg_ORD_ALL" name="select_product_flg" value="false">
		...
		<form id="frm-action-ORD_ALL">
			...
			<div class="table table__wrap tabNum tabNum_01">
				<div class="table__filter">
					...
					<div style="width:50%;">
						<div class="btn" style="width:100px;text-align:center;float:right;" onClick="openSelectColumnModal('ORD_ALL');">설정</div>
					</div>
				</div>
				<div class="double__table__container">
					<div class="overflow-x-auto top__scroll">
						<table class="checkbox__table">
							...
							<tbody id="result_checkbox_table_ORD_ALL">
							</tbody>
						</table>
					</div>
					<div class="overflow-x-auto top__scroll">
