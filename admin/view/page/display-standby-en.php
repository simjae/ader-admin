	...
	<div class="card__body">
		<form id="frm-standby-filter_EN" action="order/standby/list/get">
			...
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="rd__block">
						<input id="member_level_EN_all" type="radio" name="member_level" value="ALL" checked>
						<label for="member_level_EN_all" style="min-width:60px;">전체</label>
<?php
...
?>
						<input id="member_level_EN_<?=$level_info['IDX']?>" type="radio" name="member_level" value="<?=$level_info['IDX']?>">
						<label for="member_level_EN_<?=$level_info['IDX']?>"><?=$level_info['TITLE']?></label>				    
<?php
						}
?>
					</div>
	...
	<div class="card__footer">
		<div class="footer__btn__wrap">
			...
			<div class="btn__wrap--lg">
				<div class="blue__color__btn" onClick="getStandbyList('EN');"><span>검색</span></div>
				<div class="defult__color__btn" onClick="init_filter('frm-standby-filter_EN','getStandbyList','EN')"><span>초기화</span></div>
			</div>
		</div>
	</div>
</div>
			...
			<div class="table table__wrap">
				...
				<div class="double__table__container">
					<table class="standby__checkbox__table">
						...
						<thead>
							<tr class="checkbox_tr_EN">
								<th class="check__box__area">
									<div class="td__wrap">
										<div class="cb__color">
											<label>
												<input type="checkbox" class="select" name="standby_idx[]" value="" onclick="selectAllClick(this,'EN')">
												<span></span>
											</label>
										</div>
									</div>
						...
						<tbody id="standby_checkbox_table_EN">
						</tbody>
					</table>
