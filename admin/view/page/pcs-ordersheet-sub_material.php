				...
				<table>
					...
					<tbody>
						<tr>
							...
							<td>
								<select style="border:solid 1px #bfbfbf;height:29px;" name="sub_material_type">
									<option value="" selected>부자재 타입을 선택해주세요</option>
									<option value="D">배송</option>
									<option value="T">포장</option>
							...
							<td>
								<input class="sortation" type="text" name="sortation" style="width:110px" value="">
							</td>
							<td>
								<input class="standard" type="text" name="standard" style="width:110px" value="">
							</td>
							<td>
								<input class="min_order_qty" type="text" name="min_order_qty" style="width:110px" value="">
							</td>
							<td>
								<input class="min_order_price" type="text" name="min_order_price" style="width:110px" value="">
							</td>
							<td>
								<input class="order_qty" type="text" name="order_qty" style="width:110px" value="">
							</td>
							<td>
								<input class="order_price" type="text" name="order_price" style="width:110px" value="">
							</td>
							...
							<td>
								<input class="season" type="text" name="season" style="width:250px" value="">
							</td>
							<td>
								<div class="content__date__picker">
									<input id="production_from" class="date_param" type="date" name="production_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="production" onChange="dateParamChange(this);">
									<font>~</font>
									<input id="production_to" class="date_param" type="date" name="production_to" placeholder="To" readonly style="width:150px;" date_type="production" onChange="dateParamChange(this);">
								</div>
							</td>
							<td>
								<input class="specification" type="text" name="specification" style="width:250px" value="">
							</td>
							<td>
								<input class="order_team" type="text" name="order_team" style="width:250px" value="">
							</td>
							<td>
								<input class="stock_team" type="text" name="stock_team" style="width:250px" value="">
							</td>
	...
	<form id="frm-filter" action="pcs/ordersheet/td/sub_material/list/get">
		...
		<div class="card__body">
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<select class="fSelect" name="sub_material_type">
							<option value="" selected>부자재 타입을 선택해주세요</option>
							<option value="D">배송</option>
							<option value="T">포장</option>
							<option value="S">매장</option>
			...
			<div class="content__wrap">
				<div class="content__title">부자재 품목</div>
				<div class="content__row">
					<div class="cb__color">
						<label>
							<input type="checkbox" name="sub_material_cate_all" value="">
							<span>전체 부자재 품목 보기</span>
						</label>
					</div>
					<select class="fSelect category eCategory eCategory1" depth="1" name="sub_material_cate_idx[]" style="font-size:0.5rem;width:120px;" onChange="">
						<option value="">대품목</option>
					</select>
					
					<select class="fSelect category eCategory eCategory2" depth="2" name="sub_material_cate_idx[]" style="font-size:0.5rem;width:120px;" onChange="">
						<option value="">중품목</option>
					</select>
					
					<select class="fSelect category eCategory eCategory3" depth="3" name="sub_material_cate_idx[]" style="font-size:0.5rem;width:120px;" onChange="">
						<option value="">소품목</option>
					</select>
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					<div class="content__title">부자재 이름</div>
					<div class="content__row">
						<input type="text" name="sub_material_name" value="">
					</div>
				</div>
				<div class="half__box__wrap">
					<div class="content__title">부자재 코드</div>
					<div class="content__row">
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					<div class="content__title">업체명</div>
					<div class="content__row">
						<input type="text" name="sub_material_name" value="">
					</div>
				</div>
				<div class="half__box__wrap">
					<div class="content__title">시즌 (프로젝트)</div>
					<div class="content__row">
						<input type="text" name="sub_material_code" value="">
					</div>
				</div>
			...
			<div class="content__wrap">
				<div class="content__title">제작 기간</div>
				<div class="content__row">
					<div class="content__date__wrap">
						<div class="content__date__btn">
							<input id="search_date_production" type="hidden" name="search_date" value="" style="width:150px;">

							<div class="search_date_production date__picker" date_type="production" date="all" type="button" onclick="searchDateClick(this);">전체</div>
							<div class="search_date_production date__picker" date_type="production" date="today" type="button" onclick="searchDateClick(this);">오늘</div>
							<div class="search_date_production date__picker" date_type="production" date="01d" type="button" onclick="searchDateClick(this);">어제</div>
							<div class="search_date_production date__picker" date_type="production" date="03d" type="button" onclick="searchDateClick(this);">3일</div>
							<div class="search_date_production date__picker" date_type="production" date="01w" type="button" onclick="searchDateClick(this);">7일</div>
							<div class="search_date_production date__picker" date_type="production" date="15d" type="button" onclick="searchDateClick(this);">15일</div>
							<div class="search_date_production date__picker" date_type="production" date="01m" type="button" onclick="searchDateClick(this);">1개월</div>
							<div class="search_date_production date__picker" date_type="production" date="03m" type="button" onclick="searchDateClick(this);">3개월</div>
							<div class="search_date_production date__picker" date_type="production" date="01y" type="button" onclick="searchDateClick(this);">1년</div>
						</div>
						<div class="content__date__picker">
							<input id="production_from" class="date_param" type="date" name="production_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="production" onChange="dateParamChange(this);">
							<font>~</font>
			...
			<div class="content__wrap">
				<div class="content__title">사양</div>
				<div class="content__row">
			...
			<div class="content__wrap grid__half">
				<div class="half__box__wrap">
					<div class="content__title">발주 담당팀</div>
					<div class="content__row">
						<input type="text" name="order_team" value="">
					</div>
				</div>
				<div class="half__box__wrap">
					<div class="content__title">재고 담당팀</div>
					<div class="content__row">
						<input type="text" name="stock_team" value="">
					</div>
				</div>
			</div>
		</div>
