...
<div class="content__card">
	<form id="frm-list_OE" action="order/list/get">
		<input type="hidden" name="tab_status" value="OE">
		...
		<div class="card__body">
			...
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row" style="display:block;">
					<div class="rd__block">
						...
						<input type="radio" id="order_status_OEX" class="radio__input" value="OEX" name="order_status">
						<label for="order_status_OEX">주문교환</label>
						
						<input type="radio" id="order_status_OEP" class="radio__input" value="OEP" name="order_status">
						<label for="order_status_OEP">교환완료</label>
					</div>
				</div>
			</div>
			<div class="content__wrap">
				<div class="content__title">교체 검색범위</div>
				<div class="content__row">
					<div class="rd__block">
						<input type="radio" id="exchange_type_ALL" class="radio__input" value="ALL" name="exchange_type" checked>
						<label for="exchange_type_ALL">전체</label>
						
						<input type="radio" id="exchange_type_OIE" class="radio__input" value="OIE" name="exchange_type">
						<label for="exchange_type_OIE">전체 교환</label>
						
						<input type="radio" id="exchange_type_OPE" class="radio__input" value="OPE" name="exchange_type">
						<label for="exchange_type_OPE">부분 교환</label>
					</div>
				</div>
			</div>
			<div class="content__wrap ">
				...
				<div class="content__row">
					...
					<div class="content__date__wrap">
						<div class="content__date__btn">
							<input id="date_param_OE" type="hidden" name="date_param" value="" style="width:150px;">

							<div class="search_date_OE date__picker" date_type="OE" date="today"	type="button" onclick="searchDateClick(this);">오늘</div>
							<div class="search_date_OE date__picker" date_type="OE" date="01d"	type="button" onclick="searchDateClick(this);">어제</div>
							<div class="search_date_OE date__picker" date_type="OE" date="03d"	type="button" onclick="searchDateClick(this);">3일</div>
							<div class="search_date_OE date__picker" date_type="OE" date="07d"	type="button" onclick="searchDateClick(this);">7일</div>
							<div class="search_date_OE date__picker" date_type="OE" date="15d"	type="button" onclick="searchDateClick(this);">15일</div>
							<div class="search_date_OE date__picker" date_type="OE" date="01m"	type="button" onclick="searchDateClick(this);">1개월</div>
							<div class="search_date_OE date__picker" date_type="OE" date="03m"	type="button" onclick="searchDateClick(this);">3개월</div>
							<div class="search_date_OE date__picker" date_type="OE" date="01y"	type="button" onclick="searchDateClick(this);">1년</div>
						</div>
						
						<div class="content__date__picker">
							<input id="date_from_OE" class="date_param_OE" type="date" name="date_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="OE" onChange="dateParamChange(this);">
								<font>~</font>
							<input id="date_to_OE" class="date_param_OE" type="date" name="date_to" placeholder="To" readonly style="width:150px;" date_type="OE" onChange="dateParamChange(this);">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="content__wrap grid__half">
				...
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="delivery_type_ALL_OE" class="radio__input" value="ALL" name="delivery_type" checked>
							<label for="delivery_type_ALL_OE">전체</label>
							
							<input type="radio" id="delivery_type_KR_OE" class="radio__input" value="KR" name="delivery_type">
							<label for="delivery_type_KR_OE">국내 배송</label>
							
							<input type="radio" id="delivery_type_FR_OE" class="radio__input" value="FR" name="delivery_type">
							<label for="delivery_type_FR_OE">해외 배송</label>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfoList('OE');"><span>검색</span></div>
					<div class="defult__color__btn" onClick="init_fileter('frm-list_OE', 'getOrderInfoList')"><span>초기화</span></div>
				</div>
			</div>
		</div> 
		<div class="hidden">
			<div class="excel__table__warp">
				<table id="excel_table_OE">
					<thead id="excel_table_head_OE">
					</thead>
					<tbody id="excel_result_table_OE">
					</tbody>
				</table>
			</div>
		</div> 
			...
			<div class="table table__wrap tabNum tabNum_01">
				<div class="table__filter">
					<div class="filrer__wrap" style="width:420px;">
						<div style="width: 140px;" class="filter__btn" onclick="excelDownload('OE', 'DF');">엑셀 다운로드(일반양식)</div>
						<div style="width: 140px;" class="filter__btn" onclick="excelDownload('OE', 'SL');">엑셀 다운로드(매출정보)</div>
						<div style="width: 140px;" class="filter__btn" onclick="putOrderInfo('OE')">환불완료처리</div>
					</div>
					<div style="width:50%;">
						<div class="btn" style="width:100px;text-align:center;float:right;" onClick="openSelectColumnModal('OE');">설정</div>
					</div>
				</div>	
				<div class="double__table__container">
					<div class="overflow-x-auto top__scroll">
						<table class="checkbox__table">
							...
							<tbody id="result_checkbox_table_OE">
							</tbody>
						</table>
					</div>
					<div class="overflow-x-auto top__scroll">
						<TABLE id="result_table_OE" style="min-width:100%;width:auto;">
