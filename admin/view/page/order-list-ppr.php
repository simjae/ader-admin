		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfo_ppr();"><span>검색</span></div>
...
function getOrderInfo_ppr() {
	let td_length = $("#result_table_ppr").children().length;
	if (td_length > 0) {
		$("#result_table_ppr").html('');
		...
		$("#result_table_ppr").append(strDiv);
	}
	
	var rows = $("#frm-list_PPR").find('.rows').val();
	var page = $("#frm-list_PPR").find('.page').val(1);
	
	get_contents($("#frm-list_PPR"),{
		pageObj : $(".paging"),
		html : function(d) {
			$("#result_table_ppr").html('');
