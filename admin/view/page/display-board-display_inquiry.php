...
function getBoardTabInfo_01() {
	...
	var page = $('#frm-list_01_'+subtab_num).find('.page').val();
			...
			d.forEach(function(row) {
				...
				var strDiv = `
					...
					if(row.answer_state == '읽지 않음'){
						...
						strDiv += `<button style="width:50px;height:30px;border:1px solid;background-color:#000000;color:#ffffff;font-size:0.5rem;" onclick="">답변완료</button>`;
					}
				strDiv +=
					`
					</TD>
