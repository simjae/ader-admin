<div class="content__card">
	...
	<div class="card__body">
		...
		<div class="story__left__area">
			...
			<div class="story__contents">
				<div class="new__container new_container_CN">
					<div class="new__item new_item_CN">
		...
		<div class="story__right__area">
			...
			<div class="archive__left__area">
				<div class="story__contents">
					...
					<div class="story__row story_prj_container_CN">
						<div class="story_list story_list_prj_CN">
			...
			<div class="archive__center__area">
				<div class="story__contents">
					...
					<div class="story__row story_lkb_container_CN">
						<div class="story_list story_list_lkb_CN">
							<div class="btn" onclick="displayNumCheck(this)" style="margin-right:5px;" recent_idx="0" recent_num="0" action_type="up">
								<i class="xi-angle-up"></i>
								<span class="tooltip top">위로</span>
							</div>
			...
			<div class="archive__right__area">
				<div class="story__contents">
					...
					<div class="story__row story_edt_container_CN">
						<div class="story_list story_list_edt_CN">
							<div class="btn" onclick="displayNumCheck(this)" style="margin-right:5px;" recent_idx="0" recent_num="0" action_type="up">
								<i class="xi-angle-up"></i>
								<span class="tooltip top">위로</span>
							</div>
			...
			<div class="table table__wrap">
				<div class="table__filter">
					<div class="filrer__wrap">
						<div class="filter__btn" onclick="openPagePostingModal('add','CN');">게시물 검색</div>
					</div>                          
				</div>
	...
	<form id="frm-put_CN" action="posting/story/put">
		...
		<div class="card__body">
			...
			<div class="table table__wrap">
				<div class="table__filter">
					<div class="filrer__wrap">
						<div class="filter__btn" onclick="openPagePostingModal('put','CN');">게시물 검색</div>
					</div>                          
				</div>
