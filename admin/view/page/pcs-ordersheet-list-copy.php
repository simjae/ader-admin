...
<div class="content__card">
	<form id="frm-filter" action="pcs/ordersheet_copy/list/get">
		...
		<div class="card__body">
			<div class="body__info--count" style="display: block;margin:20px 0;">
				...
				<div class="flex justify-between" style="gap:20px;">
					...
					<div>
						<button type="button" style="width:120px;height:30px;border:1px solid #000000;background-color:#ffffff;color:#000000;margin-right:10px;cursor:pointer;" onclick="location.href='/pcs/ordersheet/copy/regist/md'">오더시트 등록</button>
...
function openOrdersheetUpdate(obj) {
	...
	var url = "/pcs/ordersheet/copy/update/" + authority + "?";
