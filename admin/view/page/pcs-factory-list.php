...
<div class="content__card">
	<form id="frm-filter" action="pcs/factory/list/get">
			...
			d.forEach(function(row) {
				...
				strDiv = `
					<tr > 
						...
						<td>${row.num}</td>
						<td><button type="button" class="white_btn" onclick="location.href='/pcs/factory/update?factory_idx=${row.factory_idx}&product_code=${row.product_code}'">편집</button></td>
...
function factoryAction(len){
	...
	$.ajax({
		...
		data: formData,
		dataType: "json",
		url: config.api + "pcs/factory/delete",
		error: function() {
...
function getFactoryTotal(obj) {
	...
	$.ajax({
		type: "post",
		url: config.api + "pcs/factory/get",
		data: apiParam,
		dataType: "json",
		error: function() {
