<div class="content__card">
	<div class="card__header">
		<div style="display:flex;">
			...
			<div style="width:50%;">
				<div class="save_story_btn" onclick="saveSearchInfo('CN','KEY')">추천 검색어 저장</div>
			</div>
		</div>
						...
						<TBODY>
							<TR>
								...
								<TD style="text-align:center;">
									<div class="search_posting_btn" onClick="getKeywordModal('CN','ADD',0);">검색</div>
								</TD>
								<TD>
								...
								<TD style="text-align:center;">
									<div class="add_recommend_keyword_btn btn" onClick="addRecommendKeyword('CN');">등록</div>
								</TD>
							</TR>
						</TBODY>
					</TABLE>
		...
		<div class="table table__wrap">
			<div class="table__filter">
				<div class="filrer__wrap">
					<div style="width: 140px;" class="filter__btn" onClick="deleteRecommendKeyword('CN');">삭제</div>
				</div>                                
			</div>
			...
			<div class="overflow-x-auto">
				<TABLE>
					...
					<TBODY class="result_table_KEY_CN">
...
<div class="content__card">
	<div class="card__header">
		<div style="display:flex;">
			...
			<div style="width:50%;">
				<div class="save_story_btn" onclick="saveSearchInfo('CN','PRD')">실시간 인기 상품 저장</div>
			</div>
		</div>
		<div class="drive--x"></div>
	</div>
	...
	<div class="card__body">
		<form id="frm-PRD_CN">
			<div class="table table__wrap">
				<div class="table__filter">
					<div class="filrer__wrap">
						<div style="width: 140px;" class="filter__btn" onClick="deletePopularProduct('CN');">삭제</div>
						<div style="width: 140px;" class="filter__btn" onClick="getProductModal('CN');">추가</div>
					</div>                                
				</div>
				...
				<div class="overflow-x-auto">
					<TABLE>
						...
						<TBODY class="result_table_PRD_CN">
...
$(document).ready(function() {
	getRecommendKeywordList('CN');
	getPopularProductList('CN');
});
</script>