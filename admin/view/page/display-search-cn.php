						...
						<TBODY>
							<TR>
								...
								<TD style="text-align:center;">
									<div class="search_posting_btn" onClick="getKeywordModal('CN');">검색</div>
								</TD>
								<TD>
	...
	<div class="card__body">
		<form id="frm-PRD_CN">
			<div class="table table__wrap">
				<div class="table__filter">
					<div class="filrer__wrap">
						<div style="width: 140px;" class="filter__btn" onClick="deleteProduct('CN');">삭제</div>
...
$(document).ready(function() {
	getRecommendKeyword('CN');
	getPopularProduct('CN');
});
</script>