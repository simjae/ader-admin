								...
								<tbody style="height: 20vh;">
									...
									<tr>
										<td>
											<div class="contents__btn__wrap" style="display:flex;">
												<div class="rd__block">
													<input id="images_bg_color_BL_KR" type="radio" name="background_color" value="BL" checked>
													<label for="images_bg_color_BL_KR">BLACK</label>

													<input id="images_bg_color_WH_KR" type="radio" name="background_color" value="WH">
													<label for="images_bg_color_WH_KR">WHITE</label>
												</div>
											</div>
										</td>
									</tr>
