		...
		<div class="card__body">
			...
			<div class="content__wrap grid__half">
				...
				<div class="half__box__wrap">
					...
					<div class="content__row">
						<div class="rd__block">
							<input type="radio" id="delivery_type_ALL_DPG" class="radio__input" value="" name="delivery_type" checked>
							<label for="delivery_type_ALL_ALL">전체</label>
							
							<input type="radio" id="delivery_type_KR_DPG" class="radio__input" value="" name="delivery_type">
							<label for="delivery_type_KR_ALL">국내 배송</label>
							
							<input type="radio" id="delivery_type_FR_DPG" class="radio__input" value="" name="delivery_type">
