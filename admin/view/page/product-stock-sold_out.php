<div class="content__card">
	<form id="frm-list_03" action="product/stock/list/get">
		...
		<input type="hidden" name="sold_out_status" value="false">
				...
				<div class="content__row">
					...
					<div class="content__date__wrap">
						<div class="content__date__btn">
							<input id="search_date_sold_out" type="hidden" name="search_date" value="" style="width:150px;">
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="all" type="button" onclick="searchDateClick(this);">전체</div>
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="today" type="button" onclick="searchDateClick(this);">오늘</div>
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="01d" type="button" onclick="searchDateClick(this);">어제</div>
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="03d" type="button" onclick="searchDateClick(this);">3일</div>
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="07d" type="button" onclick="searchDateClick(this);">7일</div>
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="15d" type="button" onclick="searchDateClick(this);">15일</div>
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="01m" type="button" onclick="searchDateClick(this);">1개월</div>
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="03m" type="button" onclick="searchDateClick(this);">3개월</div>
							<div class="search_date_sold_out date__picker" date_type="sold_out" date="01y" type="button" onclick="searchDateClick(this);">1년</div>
						</div>
						<div class="content__date__picker">
							<input id="sold_out_from" class="date_param" type="date" name="date_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="sold_out" onChange="dateParamChange(this);">
							<font>~</font>
							<input id="sold_out_to" class="date_param" type="date" name="date_to" placeholder="To" readonly style="width:150px;" date_type="sold_out" onChange="dateParamChange(this);">
						</div>
					</div>
				</div>
			</div>
			...
			<div class="card__body--hide detail_hidden" style="display: none;">
				...
				<div class="content__wrap grid__half">
					...
					<div class="half__box__wrap">
						...
						<div class="content__row">
							<div class="rd__block">
								<input id="soldout_sale_status_all" type="radio" name="sale_flg" value="all" checked>
								<label for="soldout_sale_status_all">전체</label>
								
								<input id="soldout_sale_status_true" type="radio" name="sale_flg" value="true">
								<label for="soldout_sale_status_true" >판매 함</label>
							
								<input id="soldout_sale_status_false" type="radio" name="sale_flg" value="false">
		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					...
					<div class="defult__color__btn" onClick="init_filter('frm-list_03', 'getProductStockInfo_03')"><span>초기화</span></div>
				</div>
			</div>
		</div> 
	</form>
