...
<div class="card__body">
    <div class="hidden"><input class="upload_btn" id="upload_btn_03" name="upload_btn_03" type="file" style="visibility:hidden"></div>
    <div class="table table__wrap">
        <div class="overflow-x-auto">
            <table>
                ...
                <tbody>
                    <tr>
                        <td style="width: 20%;">세트상품 수정용 엑셀 다운로드</td>
                        <td><div class="exel__btn"><a href="http://116.124.128.246:81/excel_form/세트상품 수정 엑셀.xlsx" download>다운로드</a></div></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <div class="table table__wrap">
        <div class="overflow-x-auto">
            <table>
                ...
                <TBODY id="wait_list_table_03">
                </TBODY>
            </table>
        </div>
        <div class="exel__btn__wrap">
            <div class="exel__btn blue exel__execute__btn">세트상품 수정</div>
