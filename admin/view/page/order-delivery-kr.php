...
<form id="frm-msg-update-KR" action="order/delivery/message/put">
...
?>
			...
			<div class="justify-center btn__wrap--lg">
				<div  class="blue__color__btn" onClick="updateDeliveryMsg('KR')"><span>모든 항목 저장</span></div>
			</div>
		</div>
	</div>
</form>
<div class="content__card">
	<form id="frm-company-filter-KR" action="order/delivery/company/list/get">
		<input type="hidden" name="country" value="KR">
		...
		<div class="card__body">
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="rd__block">
						<input type="radio" id="delivery_country_KR_ALL" class="radio__input" value="ALL" name="delivery_country" checked>
						<label for="delivery_country_KR_ALL">전체</label>
						
						<input type="radio" id="delivery_country_KR_KR" class="radio__input" value="KR" name="delivery_country">
						<label for="delivery_country_KR_KR">국내 배송</label>
						
						<input type="radio" id="delivery_country_KR_KF" class="radio__input" value="KF" name="delivery_country">
						<label for="delivery_country_KR_KF">해외 배송</label>
					</div>
				</div>
			</div>
			<div class="content__wrap ">
				...
				<div class="content__row">
					<div class="rd__block">
						<input type="radio" id="default_flg_KR_ALL" class="radio__input" value="ALL" name="default_flg" checked>
						<label for="default_flg_KR_ALL">전체</label>
						
						<input type="radio" id="default_flg_KR_TRUE" class="radio__input" value="TRUE" name="default_flg">
						<label for="default_flg_KR_TRUE">기본 배송사</label>
						
						<input type="radio" id="default_flg_KR_FALSE" class="radio__input" value="FALSE" name="default_flg">
						<label for="default_flg_KR_FALSE">일반 배송사</label>
					</div>
				</div>
			</div>
			<div class="content__wrap ">
			...
			<div class="justify-center btn__wrap--lg" style="margin-top:20px; margin-bottom:30px;">
				<div  class="blue__color__btn" onClick="getDeliveryCompanyList('KR');"><span>검색</span></div>
				<div class="defult__color__btn" onClick="init_fileter('frm-company-filter-KR','getDeliveryCompanyList','KR')"><span>초기화</span></div>
			</div>
		</div>
		<div class="card__header">
			<h3>배송업체 목록</h3>
			...
			<div class="table table__wrap" style="width: 100%;">
				<div class="table__filter">
					<div class="filrer__wrap">
						<div class="filter__btn" onClick="addCompany('KR')">등록</div>
						<div class="filter__btn" onClick="deleteCompany('KR')">삭제</div>
					</div>
				</div>
				<TABLE id="excel_company_table_KR">
					<THEAD>
						<TR>
							<TH style="width:3%;">
								<div class="cb__color">
					...
					<TBODY id="result_company_table_KR">
					</TBODY>
				</TABLE>
			</div>
...
<div class="content__card">
	<form id="frm-location-filter-KR" action="order/delivery/location/list/get">
		<input type="hidden" name="country" value="KR">
		...
		<div class="card__body">
			...
			<div class="justify-center btn__wrap--lg" style="margin-top:20px; margin-bottom:30px;">
				<div  class="blue__color__btn" onClick="getDeliveryLocationList('KR');"><span>검색</span></div>
				<div class="defult__color__btn" onClick="init_fileter('frm-location-filter-KR','getDeliveryLocationList','KR')"><span>초기화</span></div>
			</div>
		</div>
		<div class="card__header">
			<h3>지역별 배송비 목록</h3>
		...
		<div class="card__body">
			...
			<div class="table table__wrap" style="width: 100%;">
				<div class="table__filter">
					<div class="filrer__wrap">
						<div class="filter__btn" onClick="addLocation('KR')">등록</div>
						<div class="filter__btn" onClick="deleteLocation('KR')">삭제</div>
					</div>
				</div>
				<TABLE id="excel_location_table_KR">
					<THEAD>
						<TR>
							<TH style="width:3%;">
								<div class="cb__color">
					...
					<TBODY id="result_location_table_KR">
					</TBODY>
				</TABLE>
			</div>
			<div class="padding__wrap">
...
$(document).ready(function(){
	getDeliveryCompanyList('KR');
	getDeliveryLocationList('KR');
})
</script>