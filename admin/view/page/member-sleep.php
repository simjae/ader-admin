<h1>휴면 계정<small>접속국가가 한국인 회원만 적용</small></h1>
	...
	<div class="portlet">
		<div class="body">
			<div class="row">
				...
				<input type="hidden" name="status" value="휴면">
				...
				<thead>
					<tr>
						...
						<th class="sort" data-query="code">이메일</th>
						<th style="width:10%" class="sort" data-query="code">가입일</th>
						<th style="width:15%" class="sort" data-query="code">최종 접속일</th>
				...
				<tbody id="list">
					<tr>
						<td colspan="9" class="nodata"><i class="xi-ban"></i><br>휴면 계정이 없습니다</td>
					</tr>
				</tbody>
				</table>
				</form>
