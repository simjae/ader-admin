...
<div class="content__card">
	<form id="frm-draw-put" action="order/draw/put">
...
?>
        ...
        <div class="footer__btn__wrap">
            ...
            <div class="btn__wrap--lg">
                <div class="blue__color__btn" onClick="putDraw('KR');"><span>드로우 편집</span></div>
                    ...
                    $.ajax({
                        ...
                        success: function(d) {
                            ...
                            if (code == 200) {
                                ...
                                $('input[name="product_idx"]').val(data.product_idx);
