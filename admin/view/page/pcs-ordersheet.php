    ...
    <div class="card__body">
                        ...
                        <TABLE style="margin-top:5px">
                            <TBODY>
                                ...
                                <tr>
                                    <td>
										상품 적재박스 유형
										<input type="hidden" id="box_idx" value="0">
									</td>
		...
		<div class="flex justify-center">
            <button type="button"
				...
				onClick="location.href='/pcs/ordersheet/list'">돌아가기</button>
		</div>
    </div>
</div>
<script>
	...
	$.ajax({
        ...
        success: function(d) {
            if(d.code == 200) {
                ...
                if(option_info.length > 0){
                    colunm_name_size_1 = option_info[0].size_title_1;
					colunm_name_size_2 = option_info[0].size_title_2;
					colunm_name_size_3 = option_info[0].size_title_3;
					colunm_name_size_4 = option_info[0].size_title_4;
					colunm_name_size_5 = option_info[0].size_title_5;
					colunm_name_size_6 = option_info[0].size_title_6;
                    ...
                    `;
                    strTh += `<th>${colunm_name_size_1}</th>`;
                    strTh += `<th>${colunm_name_size_2}</th>`;
                    strTh += `<th>${colunm_name_size_3}</th>`;
                    strTh += `<th>${colunm_name_size_4}</th>`;
                    strTh += `<th>${colunm_name_size_5}</th>`;
                    strTh += `<th>${colunm_name_size_6}</th>`;
					...
					$('#option_tr').html('<TD colspan="12">등록된 옵션 정보가 없습니다.</TD>');
				}
		...
		function(){
			...
			if(box_idx > 0){
				...
				$('#box_info_table').append("적재박스 미선택");
			}
		}
	).then(
        function(){
