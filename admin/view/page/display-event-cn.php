<div class="content__card">
	...
	<div class="card__body">
		<form id="frm-filter-event-info-CN" action="event/list/get">
				...
				<div class="content__row">
					<div class="content__date__wrap">
						<div class="content__date__btn">
							<input id="search_date_event_create_CN" type="hidden" name="search_date" value="" style="width:150px;">
	...
	<div class="card__footer">
		<div class="footer__btn__wrap" style="grid: none;">
			<div class="btn__wrap--lg">
				<div  class="blue__color__btn" onClick="getEventInfoList('CN');"><span>검색</span></div>
				<div class="defult__color__btn" onClick="init_filter('frm-filter-event-info-CN','getEventInfoList','CN');"><span>초기화</span></div>
			</div>
		</div>
	</div> 
</div>
<div class="content__card">
	...
	<div class="card__body">
		<form id="frm-list-event-info-CN">
			...
			<div class="table table__wrap">
				...
				<div class="overflow-x-auto">
					<table id="excel_table_event_info_CN">
						<thead>
							<tr>
								<TH style="width:3%;">
									<div class="cb__color">
						...
						<tbody id="result_event_info_table_CN">
							<tr>
...
<div class="content__card">
	<div class="card__header">
		<h3 id="event_filter_title_CN">이벤트 참여자(당첨자) 목록 검색</h3>
		<div class="drive--x"></div>
	</div>
	<div class="card__body">
		<form id="frm-filter-event-CN" action="event/submit/get">
			<input type="hidden" class="sort_type" name="sort_type" value="DESC">
			<input type="hidden" class="sort_value" name="sort_value" value="IDX">
			...
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="content__date__wrap">
						<div class="content__date__btn">
							<input id="search_date_event_apply_CN" type="hidden" name="search_date" value="" style="width:150px;">
	...
	<div class="card__footer">
		<div class="footer__btn__wrap" style="grid: none;">
			<div class="btn__wrap--lg">
				<div  class="blue__color__btn" onClick="getEventList('CN')"><span>검색</span></div>
				<div class="defult__color__btn" onClick="init_filter('frm-filter-event-CN','getEventList','CN')"><span>초기화</span></div>
			</div>
		</div>
	</div> 
</div>
<div class="content__card">
	<div class="card__header">
		<h3 id="event_result_title_CN">이벤트 참여자(당첨자) 결과</h3>
		<div class="drive--x"></div>
	</div>
	<div class="card__body">
		...
		<div class="table table__wrap" >
			...
			<div class="overflow-x-auto">
				<table id="excel_table_event_CN">
					...
					<tbody id="result_event_table_CN">
						<tr>
