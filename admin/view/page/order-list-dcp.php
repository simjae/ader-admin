<div class="content__card">
	<form id="frm-list_DCP" action="order/list/get">
		<input type="hidden" name="tab_status" value="DCP">
		...
		<input type="hidden" class="select_product_flg_DCP" name="select_product_flg" value="false">
				...
				<div class="content__row">
					...
					<div class="content__date__wrap">
						<div class="content__date__btn">
							<input id="date_param_DCP" type="hidden" name="date_param" value="" style="width:150px;">

							<div class="search_date_DCP date__picker" date_type="DCP" date="today"	type="button" onclick="searchDateClick(this);">오늘</div>
							<div class="search_date_DCP date__picker" date_type="DCP" date="01d"	type="button" onclick="searchDateClick(this);">어제</div>
							<div class="search_date_DCP date__picker" date_type="DCP" date="03d"	type="button" onclick="searchDateClick(this);">3일</div>
							<div class="search_date_DCP date__picker" date_type="DCP" date="07d"	type="button" onclick="searchDateClick(this);">7일</div>
							<div class="search_date_DCP date__picker" date_type="DCP" date="15d"	type="button" onclick="searchDateClick(this);">15일</div>
							<div class="search_date_DCP date__picker" date_type="DCP" date="01m"	type="button" onclick="searchDateClick(this);">1개월</div>
							<div class="search_date_DCP date__picker" date_type="DCP" date="03m"	type="button" onclick="searchDateClick(this);">3개월</div>
							<div class="search_date_DCP date__picker" date_type="DCP" date="01y"	type="button" onclick="searchDateClick(this);">1년</div>
						</div>
						
						<div class="content__date__picker">
							<input id="date_from_DCP" class="date_param_DCP" type="date" name="date_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="DCP" onChange="dateParamChange(this);">
								<font>~</font>
							<input id="date_to_DCP" class="date_param_DCP" type="date" name="date_to" placeholder="To" readonly style="width:150px;" date_type="DCP" onChange="dateParamChange(this);">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfoList('DCP');"><span>검색</span></div>
					<div class="defult__color__btn" onClick="init_fileter('frm-list_DCP', 'getOrderInfoList')"><span>초기화</span></div>
				</div>
			</div>
		</div>
		<div class="hidden">
			<div class="excel__table__warp">
				<table id="excel_table_DCP">
					<thead id="excel_table_head_DCP">
					</thead>
					<tbody id="excel_result_table_DCP">
					</tbody>
				</table>
			</div>
		</div> 
				...
				<div class="double__table__container">
					<div class="overflow-x-auto top__scroll">
						<table class="checkbox__table">
							...
							<tbody id="result_checkbox_table_DCP">
							</tbody>
						</table>
					</div>
					<div class="overflow-x-auto top__scroll">
						<TABLE id="result_table_DCP" style="min-width:100%;width:auto;">
