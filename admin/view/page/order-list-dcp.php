		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfo_dcp();"><span>검색</span></div>
...
function getOrderInfo_dcp() {
	let td_length = $("#result_table_dcp").children().length;
	if (td_length > 0) {
		$("#result_table_dcp").html('');
		...
		$("#result_table_dcp").append(strDiv);
	}
	
	var rows = $("#frm-list_DCP").find('.rows').val();
	var page = $("#frm-list_DCP").find('.page').val(1);
	
	get_contents($("#frm-list_DCP"),{
		pageObj : $(".paging"),
		html : function(d) {
			$("#result_table_dcp").html('');
