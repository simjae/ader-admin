...
<div class="content__card">
	<div class="card__header">
		<div class="flex justify-between">
			<h3>영문몰 드로우 검색</h3>
			<div class="black-btn" onclick="moveRegistPage('EN')">영문몰 드로우 등록</div>
		</div>
		<div class="drive--x"></div>
	</div>

	<div class="card__body">
		<form id="frm-draw-filter_EN" action="order/draw/list/get">
	...
	<div class="card__footer">
		<div class="footer__btn__wrap">
			...
			<div class="btn__wrap--lg">
				...
				<div class="defult__color__btn" onClick="init_fileter('frm-draw-filter_EN','getDrawList','EN')"><span>초기화</span></div>
			</div>
		</div>
	</div>
</div>
			...
			<div class="table table__wrap">
				...
				<div class="double__table__container">
					<table class="draw__checkbox__table">
						...
						<tbody id="draw_checkbox_table_EN">
						</tbody>
					</table>
