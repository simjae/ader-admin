				...
				<div class="content__row">
					...
					<div class="content__date__wrap">
						<div class="content__date__btn">
							...
							<div class="date_param_OR date__picker" date_type="OR" date="today"	type="button" onclick="searchDateClick(this);">오늘</div>
							<div class="date_param_OR date__picker" date_type="OR" date="01d"	type="button" onclick="searchDateClick(this);">어제</div>
							<div class="date_param_OR date__picker" date_type="OR" date="03d"	type="button" onclick="searchDateClick(this);">3일</div>
							<div class="date_param_OR date__picker" date_type="OR" date="07d"	type="button" onclick="searchDateClick(this);">7일</div>
							<div class="date_param_OR date__picker" date_type="OR" date="15d"	type="button" onclick="searchDateClick(this);">15일</div>
							<div class="date_param_OR date__picker" date_type="OR" date="01m"	type="button" onclick="searchDateClick(this);">1개월</div>
							<div class="date_param_OR date__picker" date_type="OR" date="03m"	type="button" onclick="searchDateClick(this);">3개월</div>
						</div>
						
						<div class="content__date__picker">
							<input id="date_from_OR" class="date_param_OR" type="date" name="date_from" class="margin-bottom-6" placeholder="From" readonly style="width:150px;" date_type="all" onChange="dateParamChange(this);">
								<font>~</font>
							<input id="date_to_OR" class="date_param_OR" type="date" name="date_to" placeholder="To" readonly style="width:150px;" date_type="all" onChange="dateParamChange(this);">
						</div>
					</div>
				</div>
			</div>
		...
		<div class="card__footer">
			<div class="footer__btn__wrap">
				...
				<div class="btn__wrap--lg">
					<div  class="blue__color__btn" onClick="getOrderInfo_or();"><span>검색</span></div>
...
function getOrderInfo_or() {
	let td_length = $("#result_table_or").children().length;
	if (td_length > 0) {
		$("#result_table_or").html('');
		...
		$("#result_table_or").append(strDiv);
	}
	
	var rows = $("#frm-list_OR").find('.rows').val();
	var page = $("#frm-list_OR").find('.page').val(1);
	
	$("#result_table_or").append(strDiv);
	
	get_contents($("#frm-list_OR"),{
		pageObj : $(".paging"),
		html : function(d) {
			$("#result_table_or").html('');
