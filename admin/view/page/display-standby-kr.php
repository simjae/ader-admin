	...
	<div class="card__footer">
		<div class="footer__btn__wrap">
			...
			<div class="btn__wrap--lg">
				<div class="blue__color__btn" onClick="getStandbyList('KR');"><span>검색</span></div>
				<div class="defult__color__btn" onClick="init_filter('frm-standby-filter_KR','getStandbyList','KR')"><span>초기화</span></div>
			</div>
		</div>
	</div>
</div>
			...
			<div class="table table__wrap">
				...
				<div class="double__table__container">
					<table class="standby__checkbox__table">
							...
							<tr class="checkbox_tr_KR">
								<th class="check__box__area">
									<div class="td__wrap">
										<div class="cb__color">
											<label>
												<input type="checkbox" class="select" name="standby_idx[]" value="" onclick="selectAllClick(this,'KR')">
												<span></span>
											</label>
										</div>
									</div>
						...
						<tbody id="standby_checkbox_table_KR">
						</tbody>
					</table>
