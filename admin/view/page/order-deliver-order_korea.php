	...
	<div class="content__card">
		...
		<div class="card__body">
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row" style="display: block;">
					<div class="rd__block" style="margin-bottom: 10px;">
						<input type="radio" id="autoAppl1_1" class="radio__input" value="" name="autoAppl" checked="checked"/>
						<label for="autoAppl1_1">사용함</label>
						<input type="radio" id="autoAppl1_2" class="radio__input" value="" name="autoAppl"/>
						<label for="autoAppl1_2">사용안함</label>
					</div>
					<div class="cb__color">
						<label>
			...
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row" style="display: block;">
					<div class="rd__block" style="margin-bottom:10px;">
						<input type="radio" id="autoCheck1_1" class="radio__input" value="" name="autoCheck" checked="checked"/>
						<label for="autoCheck1_1">사용함</label>
						<input type="radio" id="autoCheck1_2" class="radio__input" value="" name="autoCheck"/>
						<label for="autoCheck1_2">사용안함</label>
					</div>
					<div>
	...
	<div class="content__card">
		...
		<div class="card__body">
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row" style="display: block;">
					<div class="rd__block" style="margin-bottom: 10px;">
						<input type="radio" id="refundFlg1_1" class="radio__input" value="" name="refundFlg"/>
						<label for="refundFlg1_1">사용함</label>
						<input type="radio" id="refundFlg1_2" class="radio__input" value="" name="refundFlg"/>
						<label for="refundFlg1_2">사용 안함</label>
					</div>
				</div>
			</div>
			<div class="content__wrap" style="align-items: start;">
			...
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="rd__block">
						<input type="radio" id="productReady1_1" class="radio__input" value="" name="productReady"/>
						<label for="productReady1_1">사용함</label>
						<input type="radio" id="productReady1_2" class="radio__input" value="" name="productReady"/>
						<label for="productReady1_2">사용안함</label>
					</div>
				</div>
			</div>
			<div class="content__wrap" style="align-items: start;">
			...
			<div class="content__wrap" style="align-items: self-start;">
				...
				<div class="content__row" style="display: block;">
					<div class="rd__block"style="display: block;">
						<input type="radio" id="autoCancel1_1" class="radio__input" value="" name="autoCancel"/>
						<label for="autoCancel1_1">사용함</label>
						<div style="margin: 10px 15px;display: grid;row-gap: 10px;">
							<div class="autoCancel__wrap1">
								<span>* 무통장입금 :</span>
					...
					<div class="rd__block">
						<input type="radio" id="autoCancel1_2" class="radio__input" value="" name="autoCancel"/>
						<label for="autoCancel1_2">사용안함</label>
					</div>
				</div>
			</div>
			<div class="content__wrap" style="align-items: start;">
				...
				<div class="content__row">
					<div class="rd__block" style="flex-direction: column;">
						<input type="radio" id="adminMemo1_1" class="radio__input" value="" name="adminMemo"/>
						<label for="adminMemo1_1">취소/반품/교환/환불 사유 입력시 관리자 메모에 연동함</label>
						<input type="radio" id="adminMemo1_2" class="radio__input" value="" name="adminMemo"/>
						<label for="adminMemo1_2">취소/반품/교환/환불 사유 입력시 관리자 메모에 연동안함</label>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="content__card">
		...
		<div class="card__body">
			...
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="rd__block">
						<input id="deliverCostPerEachFlg1_1" type="radio" name="deliverCostPerEachFlg" value="" checked>
						<label for="deliverCostPerEachFlg1_1">사용함</label>
						
						<input id="deliverCostPerEachFlg1_2" type="radio" name="deliverCostPerEachFlg" value="">
						<label for="deliverCostPerEachFlg1_2">사용안함</label>
					</div>
				</div>
			</div>
			<div class="content__wrap">
				...
				<div class="content__row">
					<div class="rd__block">
						<input id="deliverCostCalcFlg1_1" type="radio" name="deliverCostCalcFlg" value="" checked>
						<label for="deliverCostCalcFlg1_1">상품별로 배송비 계산</label>
						
						<input id="deliverCostCalcFlg1_2" type="radio" name="deliverCostCalcFlg" value="">
						<label for="deliverCostCalcFlg1_2">품목별로 배송비 계산</label>
					</div>
				</div>
			</div>
			<div class="body__info--count">
