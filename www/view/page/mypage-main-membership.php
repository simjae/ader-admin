...
.member__level__item{width:100%}
.level__box.one{background-color:#c8c8c8;}
.level__box.two{background-color:#a1a1a1;}
.level__box.three{background-color:#7a7a7a;}
.level__box.four{background-color:#585858;}
.level__box.five{background-color:#373737;}
.level__box.six{background-color:#000;}
.level__box.seven{background-color:#000;}
...
@media (max-width: 1024px){
    ...
    .level__info__item{margin:20px 0;}
    .level__info__item .title{height:19px;}
}
