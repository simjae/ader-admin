    ...
    <div class="bluemark__tab__wrap">
        <div class="bluemark__tab verify__form__wrap">
            ...
            <div class="description">
                <p class="bluemark_explain" data-i18n="b_bluemark_info">&nbsp;&nbsp;BLUE MARK는 본 브랜드의 모조품으로부터 소비자의 혼란을 최소화하기 위해 제공되는 정품 인증
            ...
            <div class="verify_form">
                <input data-i18n="b_bluemark_serial_code" class="bluemark_serial_code" type="text" name="serial_code" placeholder="BLUE MARK 시리얼 코드">
            </div>
            <div class="button">
        ...
        <div class="bluemark__tab verify__list__wrap" accesskey="" style="position:relative">
            ...
            <div class="description verify_pc">
                ...
                <p data-i18n="b_bluemark_msg_05" style="white-space: nowrap;">·&nbsp;블루마크 코드 양도를 희망하시는 경우 제품 양도하기를 클릭하여 정보 등록을 완료해 주시길 바랍니다.</p>
            </div>
            ...
            <div class="bluemark__tab voucher__handover__wrap">
                <div class="voucher__handover__wrap_container">
                    ...
                    <div class="description_transfer">
                        <p data-i18n="b_bluemark_msg_06">·&nbsp;하단에 양도받을 아이디를 입력 후 버튼 클릭 시 블루마크 <br class="notice_br">양도신청이 접수됩니다.</p>
                        <p data-i18n="b_bluemark_msg_07">·&nbsp;정보는 향후 변경이 불가능하니 신청 전에 반드시 <br class="notice_br">확인해 주시길 바랍니다.</p>
                    </div>
                    <div>
