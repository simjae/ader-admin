<style>
    ...
    .post-change-result::-webkit-scrollbar {
        width: 5px;
    }

    .post-change-result::-webkit-scrollbar-track {
        background-color: transparent;
    }

    .post-change-result::-webkit-scrollbar-thumb {
                    ...
                    <div class="contnet__row">
                        ...
                        <div id="pw_desciption"
                            ...
                            <div class="pw__desc__title" style="margin-bottom:10px;">
                                <img src="/images/login/point_icon.svg"
                                    style="padding-top:9px;padding-right:7px;margin-bottom:8px;float:left">
...
-->
                ...
                <div class="content__wrap">
                    ...
                    <div class="contnet__row warm__msg__area">
                        <div class="grid__three">
                            <div class="left__area__wrap">
                                <input class="short__input address__input" type="number" step="1" min="1900" max="9999"
                                    name="birth_year" value="" placeholder="년">
                            </div>
                            <div class="middle__area__wrap">
                                <input class="short__input address__input" type="number" step="1" min="1" max="12"
                                    name="birth_month" value="" placeholder="월">
                            </div>
                            <div class="right__area__wrap">
                                <input class="short__input address__input" type="number" step="1" min="1" max="31"
                                    name="birth_day" value="" placeholder="일">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="content__wrap checkbox__area">
                    ...
                    <div class="content__row">
                        ...
                        <span class="font__underline" style="cursor:pointer"
                            onclick="location.href='/notice/privacy?notice_type=terms_of_use'">이용약관,</span>
                        <span class="font__small"> </span>
                        <span class="font__underline" style="cursor:pointer"
                            onclick="location.href='/notice/privacy?notice_type=privacy_policy'">개인정보수집 및 이용</span>
